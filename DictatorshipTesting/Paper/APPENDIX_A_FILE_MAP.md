...
paper ingredients A.1 and A.2.  A.3 is proved internally.  Standard-tableau connectedness is now
internal Lemma 5.3 and is not an Appendix statement.
The A.1 axiom has its faithful operator type.  A.2 bundles its faithful content
