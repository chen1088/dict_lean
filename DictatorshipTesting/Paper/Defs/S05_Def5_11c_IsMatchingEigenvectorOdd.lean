...
/-!
Paper statement: Definition 5.11 part (c) `def:matching-characters-and-eigenvectors`
...
/-- Definition 5.11 matching-character component: simultaneous odd matching-edge
