...
/-!
# Internal orthogonality theorem for matching-local truncation

This proof supplies part (c) of Proposition 4.3.
-/
...
/-- The high-degree residual is perpendicular to every matching-local degree-one function. -/
theorem matchingLocalProjection_perpendicular {α : Type*} [Fintype α] [DecidableEq α]
  ...
  constructor
  · exact horth H hH
  · have hP : IsMatchingLocalDegreeOne P M := (matchingLocalProjection_fixedSpace F M).1
