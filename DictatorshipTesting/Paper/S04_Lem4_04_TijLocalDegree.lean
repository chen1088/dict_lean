...
/-!
# Lemma 4.4: A basic indicator has local degree at most one

This is `lem:tij-local-degree` from `dictatorship_testing_stoc27_latest.tex`.
-/
...
/-- Lemma 4.4, `lem:tij-local-degree`: basic indicators have local degree at most one. -/
theorem S04_Lem4_04_TijLocalDegree {α : Type*} [Fintype α] [DecidableEq α]
