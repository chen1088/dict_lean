...
/-!
# Lemma 4.9: One-trial soundness

This is `lem:one-trial-soundness` from `dictatorship_testing_stoc27_latest.tex`.
...
/-- Lemma 4.9, `lem:one-trial-soundness`: one-trial soundness. -/
theorem S04_Lem4_09_OneTrialSoundness :
    ∃ c0 : ℝ, 0 < c0 ∧
  ...
  · intro n hn f
    ...
    have hsquare :
      ...
      S04_Prop4_08_SquareEnergyControlsGlobalDegree n hn (boolFnToReal f)
    have hreject :
        (1 / 4 : ℝ) * oneTrialDeltaSqExpectation (boolFnToReal f) ≤
