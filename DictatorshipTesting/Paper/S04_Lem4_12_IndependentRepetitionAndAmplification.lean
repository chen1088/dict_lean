...
/-!
Paper statement: Lemma 4.12 (`lem:independent-repetition`).
-/

namespace DictatorshipTesting

theorem S04_Lem4_12_repetition_rejection_probability
...
theorem S04_Lem4_12_dimension_free_amplification
    (htrial :
      ∃ c0 : ℝ, 0 < c0 ∧
