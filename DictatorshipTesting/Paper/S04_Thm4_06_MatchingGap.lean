...
import DictatorshipTesting.Paper.S05_Int_EvenSpectralBridge
import DictatorshipTesting.Paper.S05_Int_OddSpectralBridge
...
theorem S04_Thm4_06_MatchingGap
  ...
  · rcases (even_iff_exists_two_mul.mp heven) with ⟨m, rfl⟩
    ...
    have hgap15 : MatchingSpectralGapConstant (2 * m) (1 / 5 : ℝ) := by
      exact S05_evenSpectralBridge_tableauDim_evenSpectralGapFromCertificates
  ...
  · have hnotEven : ¬ Even n := Nat.not_even_iff_odd.mpr hodd
    ...
    have hgap16 : MatchingSpectralGapConstant (2 * m + 1) (1 / 6 : ℝ) := by
      exact S05_oddSpectralBridge_tableauDim_oddSpectralGapFromCertificates
