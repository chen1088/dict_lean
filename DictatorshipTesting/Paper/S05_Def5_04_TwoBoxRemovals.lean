...
/-!
Paper statement: Definition 5.4 (`def:two-box-removals`)
...
difference `2`. -/
theorem S05_Def5_04_sum_row_diff_of_horizontalTwoBoxRemoval
...
difference `2`. -/
theorem S05_Def5_04_sum_row_diff_of_verticalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
...
their parent. -/
theorem S05_Def5_04_row_le_parent_of_horizontalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
...
their parent. -/
theorem S05_Def5_04_row_le_parent_of_verticalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
...
theorem S05_Def5_04_next_parent_row_le_child_row_of_horizontalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsHorizontalTwoBoxRemoval lam mu) (i : Nat) :
...
theorem S05_Def5_04_parent_row_le_child_row_add_one_of_verticalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsVerticalTwoBoxRemoval lam mu) (i : Nat) :
...
most one box. -/
theorem S05_Def5_04_row_diff_le_one_of_verticalTwoBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsVerticalTwoBoxRemoval lam mu) (i : Nat) :
    youngRow lam i - youngRow mu i <= 1 :=
