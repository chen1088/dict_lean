...
/-!
Paper statement: Definition 5.6 (`def:one-box-removals`)
...
theorem S05_Def5_06_existsUnique_row_of_oneBoxRemoval
...
theorem S05_Def5_06_exists_removableRow_of_oneBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsOneBoxRemoval lam mu) :
    exists r : Nat,
...
theorem S05_Def5_06_sum_row_diff_of_oneBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsOneBoxRemoval lam mu) :
...
theorem S05_Def5_06_exists_removableCornerBox_of_oneBoxRemoval
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : S05_IsOneBoxRemoval lam mu) :
    exists u : Nat × Nat,
