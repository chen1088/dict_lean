...
/-- Definition 5.10 row fact: a horizontal two-box removal has total row
difference `2`. -/
...
/-- Definition 5.10 row fact: a vertical two-box removal has total row
difference `2`. -/
...
/-- Definition 5.10 row fact: horizontal two-box children are rowwise bounded by
their parent. -/
...
/-- Definition 5.10 row fact: vertical two-box children are rowwise bounded by
their parent. -/
...
/-- Definition 5.10 horizontal two-strip row condition. -/
...
/-- Definition 5.10 vertical two-strip row condition. -/
...
/-- Definition 5.10 row fact: in a vertical two-box removal, every row loses at
most one box. -/
