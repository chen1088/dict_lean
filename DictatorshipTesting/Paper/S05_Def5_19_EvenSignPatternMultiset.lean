...
- `DictatorshipTesting`
- `DictatorshipTesting.Paper.S05_Def5_20_OddSignPatternMultiset`
-/


/-!
Paper statement: Definition 5.19 (`def:even-sign-patterns`)
...
/-- Definition 5.17 scalar shadow: the empty even diagram has one zero-weight
entry. -/
...
/-- Definition 5.17 scalar shadow: zero-weight entries recurse through
...
/-- Definition 5.17 scalar shadow: the empty even diagram has no high-weight
entries. -/
...
/-- Definition 5.17 scalar shadow: high-weight entries recurse through the
