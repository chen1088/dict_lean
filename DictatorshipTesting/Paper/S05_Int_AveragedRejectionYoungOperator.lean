...
bridge.  Definition 5.12 later constructs this data for the actual
...
formalized in Lean; scalarity is proved from these fields by Lemma 5.8. -/
...
commutant-to-scalar theorem from Lemma 5.8.  This is a one-block statement; it
