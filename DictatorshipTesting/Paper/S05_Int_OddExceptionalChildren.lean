...
/-!
Internal exceptional-child classification extracted from the proof of
Lemma 5.26.
-/
...
/-- All failures of the generic odd reduction are among the two
explicit odd exceptional shapes. -/
theorem S05_oddExceptionalChildren
