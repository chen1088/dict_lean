...
theorem S05_oneBoxDeletion_deleteMaxEntry_col_strict {n : Nat}
    {lam : YoungDiagram (n + 1)}
    (T : StandardYoungTableau lam) {u : YoungCell lam}
    (hu : TableauMaxAt T u) :
    forall {a b : YoungCellExcept u},
...
def S05_oneBoxDeletion_deleteMaxAsStandardDeletedTableau {n : Nat}
    {lam : YoungDiagram (n + 1)}
    (T : StandardYoungTableau lam) {u : YoungCell lam}
    (hu : TableauMaxAt T u) :
...
def S05_oneBoxDeletion_youngCellExceptEquivChildOfOneBoxChildRow
...
preserves rows. -/
theorem S05_oneBoxDeletion_youngCellExceptEquivChild_to_row
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
    ...
    (v : YoungCellExcept u) :
    YoungCell.row
        (S05_oneBoxDeletion_youngCellExceptEquivChildOfOneBoxChildRow
...
/-- Lemma 5.6 set-level component: the parent-to-child cell equivalence
preserves columns. -/
theorem S05_oneBoxDeletion_youngCellExceptEquivChild_to_col
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_youngCellExceptEquivChild_symm_row
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_youngCellExceptEquivChild_symm_col
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
def S05_oneBoxDeletion_deleteMaxAsStandardYoungTableauOfOneBoxChildRow
...
corner. -/
def S05_oneBoxDeletion_insertMaxAsStandardYoungTableauOfOneBoxChildRow
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_deletedCornerCell_row
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
the removed row. -/
theorem S05_oneBoxDeletion_deletedCornerCell_col
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_insertMax_tableauMaxAt_deletedCorner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
the deleted corner. -/
theorem S05_oneBoxDeletion_insertMax_entry_deletedCorner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
      forall t : Nat, t ≠ r -> youngRow lam t = youngRow mu t)
    (S : StandardYoungTableau mu) :
    (S05_oneBoxDeletion_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S).entry
...
theorem S05_oneBoxDeletion_insertMax_entry_ne_deletedCorner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
    ...
    (S05_oneBoxDeletion_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S).entry v =
      Fin.castSucc
        (S.entry
...
theorem S05_oneBoxDeletion_insertMax_entry_lt_last_of_ne_deletedCorner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_delete_insert
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_insert_delete
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
def S05_oneBoxDeletion_oneBoxDeletionTableauxEquivChildTableauxOfOneBoxChildRow
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
deleted corner. -/
abbrev S05_oneBoxDeletion_OneBoxDeletionCoordinateSpace
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
def S05_oneBoxDeletion_oneBoxDeletionInner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
      forall t : Nat, t ≠ r -> youngRow lam t = youngRow mu t)
    (f g : S05_oneBoxDeletion_OneBoxDeletionCoordinateSpace h hr) : ℝ :=
...
def S05_oneBoxDeletion_deletionCoordinateMap
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_oneBoxDeletion_deletionCoordinateMap_inner
    ...
    tableauInner
      ...
      =
    S05_oneBoxDeletion_oneBoxDeletionInner h hr f g := by
  classical
