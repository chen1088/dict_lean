...
theorem S05_Lem5_02_tableauContentSequence_injective {n : Nat}
...
theorem S05_Lem5_02_diagonalContent_commonEigen_support {n : Nat}
...
theorem S05_Lem5_02_diagonalContentEigenspaces {n : Nat}
    {lam : YoungDiagram n} (T : StandardYoungTableau lam)
    (f : TableauSpace lam)
    (hf :
      ∀ a : Fin n,
