...
/-!
Paper statement: Lemma 5.3 (`lem:two-box-tableau-branching`)
...
def S05_Lem5_03_deleteFirstMaxAsTableau
...
theorem S05_Lem5_03_first_deleted_cell_removable_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
...
theorem S05_Lem5_03_after_first_deletion_unique_second_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr)) :
    ∃! v : YoungCell mu,
      TableauMaxAt (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu) v ∧
        IsRemovableCornerBox mu (YoungCell.toNatPair v) := by
  exact existsUnique_removableCornerBox_tableauMaxAt
    (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu)
...
theorem S05_Lem5_03_second_deleted_cell_removable_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr))
    {v : YoungCell mu}
    (hv : TableauMaxAt (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu) v) :
    IsRemovableCornerBox mu (YoungCell.toNatPair v) := by
  exact removableCornerBox_of_tableauMaxAt
    (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu) hv
...
theorem S05_Lem5_03_first_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr))
    (a : Fin (n + 1)) :
    tableauContentSequence (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu) a =
      tableauContentSequence T (Fin.castSucc a) := by
  exact S05_Lem5_06_deleteMax_tableauContentSequence
...
theorem S05_Lem5_03_first_deletion_childCellToParent_cellOfEntry
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    childCellToParentCellOfOneBoxChildRow h hr
      (cellOfEntry (S05_Lem5_03_deleteFirstMaxAsTableau h hr T hu) a)
      =
    cellOfEntry T (Fin.castSucc a) := by
  exact S05_Lem5_06_childCellToParent_cellOfEntry_deleteMax
    h hr (deletedCornerCellOfOneBoxChildRow h hr)
    (deletedCornerCell_row h hr) (deletedCornerCell_col h hr) T hu a

/-- Lemma 5.13 basis-level component: the first deletion preserves the row of
each remaining entry. -/
theorem S05_Lem5_03_first_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  exact S05_Lem5_06_deleteMax_cellOfEntry_row
    h hr (deletedCornerCellOfOneBoxChildRow h hr)
    (deletedCornerCell_row h hr) (deletedCornerCell_col h hr) T hu a

/-- Lemma 5.13 basis-level component: the first deletion preserves the column of
each remaining entry. -/
theorem S05_Lem5_03_first_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  exact S05_Lem5_06_deleteMax_cellOfEntry_col
    h hr (deletedCornerCellOfOneBoxChildRow h hr)
    (deletedCornerCell_row h hr) (deletedCornerCell_col h hr) T hu a
...
def S05_Lem5_03_deleteSecondMaxAsTableau
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    ...
    (hu₁ : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h₁ hr₁))
    (hu₂ :
      TableauMaxAt (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁)
        (deletedCornerCellOfOneBoxChildRow h₂ hr₂)) :
  ...
  deleteMaxAsStandardYoungTableauOfOneBoxChildRow
    ...
    (deletedCornerCell_row h₂ hr₂)
    (deletedCornerCell_col h₂ hr₂)
    (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) hu₂
...
theorem S05_Lem5_03_second_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
    ...
    tableauContentSequence
        (S05_Lem5_03_deleteSecondMaxAsTableau h₁ hr₁ h₂ hr₂ T hu₁ hu₂) a
      =
    tableauContentSequence
        (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a) := by
  exact S05_Lem5_06_deleteMax_tableauContentSequence
    h₂ hr₂ (deletedCornerCellOfOneBoxChildRow h₂ hr₂)
    (deletedCornerCell_row h₂ hr₂) (deletedCornerCell_col h₂ hr₂)
    (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) hu₂ a
...
theorem S05_Lem5_03_second_deletion_childCellToParent_cellOfEntry
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
theorem S05_Lem5_03_second_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
theorem S05_Lem5_03_second_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
entries removed. -/
theorem S05_Lem5_03_iterated_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    tableauContentSequence
      ...
      tableauContentSequence
        (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a) := by
        exact S05_Lem5_03_second_deletion_tableauContentSequence
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = tableauContentSequence T (Fin.castSucc (Fin.castSucc a)) := by
        exact S05_Lem5_03_first_deletion_tableauContentSequence
          h₁ hr₁ T hu₁ (Fin.castSucc a)

/-- Lemma 5.13 basis-level component: after two successive one-box deletions,
each remaining entry has the row it had in the original tableau. -/
theorem S05_Lem5_03_iterated_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    YoungCell.row
      ...
      YoungCell.row
        (cellOfEntry
          (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a)) := by
        exact S05_Lem5_03_second_deletion_cellOfEntry_row
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = YoungCell.row (cellOfEntry T (Fin.castSucc (Fin.castSucc a))) := by
        exact S05_Lem5_03_first_deletion_cellOfEntry_row
          h₁ hr₁ T hu₁ (Fin.castSucc a)

/-- Lemma 5.13 basis-level component: after two successive one-box deletions,
each remaining entry has the column it had in the original tableau. -/
theorem S05_Lem5_03_iterated_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    YoungCell.col
      ...
      YoungCell.col
        (cellOfEntry
          (S05_Lem5_03_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a)) := by
        exact S05_Lem5_03_second_deletion_cellOfEntry_col
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = YoungCell.col (cellOfEntry T (Fin.castSucc (Fin.castSucc a))) := by
        exact S05_Lem5_03_first_deletion_cellOfEntry_col
          h₁ hr₁ T hu₁ (Fin.castSucc a)
...
noncomputable def S05_Lem5_03_twoStepDeletionTableauxEquivChildTableaux
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
...
bijection. -/
theorem S05_Lem5_03_card_twoStepDeletionTableaux_eq_child
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam) :
...
bijection. -/
theorem S05_Lem5_03_tableauDim_fixed_twoStepDeletion
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam) :
