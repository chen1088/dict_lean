...
theorem S05_Lem5_10_youngCellExceptEquivChild_to_row
    ...
    (v : YoungCellExcept u) :
    YoungCell.row
        (S05_Lem5_10_youngCellExceptEquivChildOfOneBoxChildRow
...
theorem S05_Lem5_10_insertMax_tableauMaxAt_deletedCorner
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_10_insertMax_entry_deletedCorner
    ...
    (hr :
      ...
      forall t : Nat, t ≠ r -> youngRow lam t = youngRow mu t)
    (S : StandardYoungTableau mu) :
    (S05_Lem5_10_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S).entry
...
theorem S05_Lem5_10_insertMax_entry_ne_deletedCorner
    ...
    (S05_Lem5_10_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S).entry v =
      Fin.castSucc
        (S.entry
...
theorem S05_Lem5_10_delete_insert
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_10_insert_delete
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
def S05_Lem5_10_oneBoxDeletionTableauxEquivChildTableauxOfOneBoxChildRow
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
