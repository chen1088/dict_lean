...
-/
/-!
Paper statement: Lemma 5.10 (`lem:two-box-tableau-branching`)
...
/-- Lemma 5.10 set-level component: perform the first one-box deletion in an
iterated two-box tableau deletion. -/
def S05_Lem5_10_deleteFirstMaxAsTableau
...
/-- Lemma 5.10 set-level component: the first deleted cell is a removable corner
of the parent tableau shape. -/
theorem S05_Lem5_10_first_deleted_cell_removable_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
...
/-- Lemma 5.10 set-level component: after deleting the largest entry, the new
largest entry lies in a unique removable corner of the child shape. -/
theorem S05_Lem5_10_after_first_deletion_unique_second_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr)) :
    ∃! v : YoungCell mu,
      TableauMaxAt (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu) v ∧
        IsRemovableCornerBox mu (YoungCell.toNatPair v) := by
  exact existsUnique_removableCornerBox_tableauMaxAt
    (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu)

/-- Lemma 5.10 set-level component: any second maximum-entry cell after the first
deletion is a removable corner of the child shape. -/
theorem S05_Lem5_10_second_deleted_cell_removable_corner
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr))
    {v : YoungCell mu}
    (hv : TableauMaxAt (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu) v) :
    IsRemovableCornerBox mu (YoungCell.toNatPair v) := by
  exact removableCornerBox_of_tableauMaxAt
    (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu) hv

/-- Lemma 5.10 basis-level component: the first deletion in the two-box
branching step preserves the content sequence on the remaining entries. -/
theorem S05_Lem5_10_first_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    (hu : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h hr))
    (a : Fin (n + 1)) :
    tableauContentSequence (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu) a =
...
/-- Lemma 5.10 basis-level component: after the first deletion, the child cell
containing a remaining entry maps back to the original parent cell. -/
theorem S05_Lem5_10_first_deletion_childCellToParent_cellOfEntry
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    childCellToParentCellOfOneBoxChildRow h hr
      (cellOfEntry (S05_Lem5_10_deleteFirstMaxAsTableau h hr T hu) a)
      =
...
/-- Lemma 5.10 basis-level component: the first deletion preserves the row of
each remaining entry. -/
theorem S05_Lem5_10_first_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
...
/-- Lemma 5.10 basis-level component: the first deletion preserves the column of
each remaining entry. -/
theorem S05_Lem5_10_first_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
...
/-- Lemma 5.10 set-level component: perform the second one-box deletion after
the first one in an iterated two-box tableau deletion. -/
def S05_Lem5_10_deleteSecondMaxAsTableau
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    ...
    (hu₁ : TableauMaxAt T (deletedCornerCellOfOneBoxChildRow h₁ hr₁))
    (hu₂ :
      TableauMaxAt (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁)
        (deletedCornerCellOfOneBoxChildRow h₂ hr₂)) :
  ...
  deleteMaxAsStandardYoungTableauOfOneBoxChildRow
    ...
    (deletedCornerCell_row h₂ hr₂)
    (deletedCornerCell_col h₂ hr₂)
    (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) hu₂

/-- Lemma 5.10 basis-level component: the second deletion preserves the content
sequence on entries remaining after that deletion. -/
theorem S05_Lem5_10_second_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
    ...
    tableauContentSequence
        (S05_Lem5_10_deleteSecondMaxAsTableau h₁ hr₁ h₂ hr₂ T hu₁ hu₂) a
      =
    tableauContentSequence
        (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a) := by
  exact S05_oneBoxIntertwining_deleteMax_tableauContentSequence
    h₂ hr₂ (deletedCornerCellOfOneBoxChildRow h₂ hr₂)
    (deletedCornerCell_row h₂ hr₂) (deletedCornerCell_col h₂ hr₂)
    (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) hu₂ a

/-- Lemma 5.10 basis-level component: after the second deletion, the child cell
containing a remaining entry maps back to its cell after the first deletion. -/
theorem S05_Lem5_10_second_deletion_childCellToParent_cellOfEntry
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
/-- Lemma 5.10 basis-level component: the second deletion preserves rows relative
to the first-deleted tableau. -/
theorem S05_Lem5_10_second_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
/-- Lemma 5.10 basis-level component: the second deletion preserves columns
relative to the first-deleted tableau. -/
theorem S05_Lem5_10_second_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
...
/-- Lemma 5.10 basis-level component: after two successive one-box deletions,
the content sequence is the original content sequence with the two largest
entries removed. -/
theorem S05_Lem5_10_iterated_deletion_tableauContentSequence
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    tableauContentSequence
      ...
      tableauContentSequence
        (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a) := by
        exact S05_Lem5_10_second_deletion_tableauContentSequence
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = tableauContentSequence T (Fin.castSucc (Fin.castSucc a)) := by
        exact S05_Lem5_10_first_deletion_tableauContentSequence
          h₁ hr₁ T hu₁ (Fin.castSucc a)

/-- Lemma 5.10 basis-level component: after two successive one-box deletions,
each remaining entry has the row it had in the original tableau. -/
theorem S05_Lem5_10_iterated_deletion_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    YoungCell.row
      ...
      YoungCell.row
        (cellOfEntry
          (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a)) := by
        exact S05_Lem5_10_second_deletion_cellOfEntry_row
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = YoungCell.row (cellOfEntry T (Fin.castSucc (Fin.castSucc a))) := by
        exact S05_Lem5_10_first_deletion_cellOfEntry_row
          h₁ hr₁ T hu₁ (Fin.castSucc a)

/-- Lemma 5.10 basis-level component: after two successive one-box deletions,
each remaining entry has the column it had in the original tableau. -/
theorem S05_Lem5_10_iterated_deletion_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)} {nu : YoungDiagram n}
    (h₁ : IsOneBoxChild lam mu) {r₁ : Nat}
    (hr₁ :
  ...
  calc
    YoungCell.col
      ...
      YoungCell.col
        (cellOfEntry
          (S05_Lem5_10_deleteFirstMaxAsTableau h₁ hr₁ T hu₁) (Fin.castSucc a)) := by
        exact S05_Lem5_10_second_deletion_cellOfEntry_col
          h₁ hr₁ h₂ hr₂ T hu₁ hu₂ a
    _ = YoungCell.col (cellOfEntry T (Fin.castSucc (Fin.castSucc a))) := by
        exact S05_Lem5_10_first_deletion_cellOfEntry_col
          h₁ hr₁ T hu₁ (Fin.castSucc a)

/-- Lemma 5.10 set-level branching statement: fixing the two deleted removable
...
noncomputable def S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
...
noncomputable def S05_Lem5_10_twoBoxExtensionTableau
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    StandardYoungTableau lam :=
  ((S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux lam p).symm U).1.1
...
theorem S05_Lem5_10_twoBoxExtensionTableau_eq_insertMax_twice
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
...
theorem S05_Lem5_10_twoBoxExtensionTableau_earlier_sameRow_iff
  ...
  rw [S05_Lem5_10_twoBoxExtensionTableau_eq_insertMax_twice]
...
theorem S05_Lem5_10_twoBoxExtensionTableau_earlier_sameCol_iff
    {n : Nat} (lam : YoungDiagram (((n + 1) + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n) :
...
theorem S05_Lem5_10_twoBoxExtensionTableau_earlier_diagCoeff
    {n : Nat} (lam : YoungDiagram (((n + 1) + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n) :
...
adjacent pair that belongs to the child tableau. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_earlier_offCoeff
    {n : Nat} (lam : YoungDiagram (((n + 1) + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n) :
    youngAdjacentOffCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.castSucc (Fin.castSucc a)) =
...
two-box extension. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_earlier_swap
    {n : Nat} (lam : YoungDiagram (((n + 1) + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n)
    (hrow : ¬ adjacentSameRow U a) (hcol : ¬ adjacentSameCol U a) :
    S05_Lem5_10_twoBoxExtensionTableau lam p
  ...
  calc
    S05_Lem5_10_twoBoxExtensionTableau lam p
      ...
      S05_oneBoxDeletion_insertMaxAsStandardYoungTableauOfOneBoxChildRow
        ...
        (S05_oneBoxDeletion_insertMaxAsStandardYoungTableauOfOneBoxChildRow
          ...
          (adjacentSwapTableau U a hrow hcol)) :=
      S05_Lem5_10_twoBoxExtensionTableau_eq_insertMax_twice lam p _
    ...
    _ = adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p U)
      ...
      have hbase :
        ...
        exact (S05_Lem5_10_twoBoxExtensionTableau_eq_insertMax_twice
          lam p U).symm
      cases hbase
      rfl
...
deletion fiber. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_injective
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam) :
    Function.Injective (S05_Lem5_10_twoBoxExtensionTableau lam p) := by
  intro U V hUV
  let e := S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux lam p
...
corner. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_maxAt_firstCorner
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    TableauMaxAt (S05_Lem5_10_twoBoxExtensionTableau lam p U)
      (firstDeletedCornerOfTwoStep lam p) := by
  exact
    ((S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux lam p).symm U).1.2

/-- After deleting the largest entry of a two-box extension, the next largest
entry occupies the second deleted corner. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_nextMaxAt_secondCorner
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    TableauMaxAt
      (twoStepFirstDeletionEquiv lam p
        ((S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux lam p).symm U).1)
      (secondDeletedCornerOfTwoStepInChild lam p) := by
  exact
    ((S05_Lem5_10_twoStepDeletionTableauxEquivChildTableaux lam p).symm U).2

/-- In a two-box extension, the higher of the final adjacent labels occupies
the first deleted corner. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_final_hiCell
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    adjacentHiCell (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) =
      firstDeletedCornerOfTwoStep lam p := by
  unfold adjacentHiCell
  apply cellOfEntry_eq_of_entry
  have hmax :=
    S05_Lem5_10_twoBoxExtensionTableau_maxAt_firstCorner lam p U
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_loCell
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    adjacentLoCell (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) =
  ...
  have hmap := S05_Lem5_10_first_deletion_childCellToParent_cellOfEntry
    (twoStepFirstChild_isOneBoxChild lam p)
    (twoStepFirstChild_row_form lam p)
    T X.1.2 (Fin.last n)
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    YoungCell.row
        (adjacentLoCell (S05_Lem5_10_twoBoxExtensionTableau lam p U)
          (Fin.last n)) =
      p.second.1 := by
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_loCell]
  exact secondDeletedCornerOfTwoStepInParent_row lam p

/-- The higher final label lies in the first deleted row. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    YoungCell.row
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    adjacentSameRow (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) ↔
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_loCell_col
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    YoungCell.col
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_col
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    YoungCell.col
...
theorem S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    adjacentSameCol (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) ↔
      youngRow (deleteTwoRemovableRowsDiagram lam p) p.second.1 =
        youngRow (twoStepFirstChild lam p) p.first.1 := by
  unfold adjacentSameCol
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_loCell_col,
    S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_col]

/-- The axial distance of the final two labels depends only on the two removed
boxes, not on the child tableau. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_final_axialDistance_eq
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U V : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    adjacentAxialDistance (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.last n) =
      adjacentAxialDistance (S05_Lem5_10_twoBoxExtensionTableau lam p V)
        (Fin.last n) := by
    ...
    YoungCell.content
        ...
        YoungCell.content
          (adjacentLoCell (S05_Lem5_10_twoBoxExtensionTableau lam p U)
            (Fin.last n)) =
      YoungCell.content
          (adjacentHiCell (S05_Lem5_10_twoBoxExtensionTableau lam p V)
            (Fin.last n)) -
        YoungCell.content
          (adjacentLoCell (S05_Lem5_10_twoBoxExtensionTableau lam p V)
            (Fin.last n))
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_hiCell,
    S05_Lem5_10_twoBoxExtensionTableau_final_loCell,
    S05_Lem5_10_twoBoxExtensionTableau_final_hiCell,
    S05_Lem5_10_twoBoxExtensionTableau_final_loCell]

/-- The diagonal coefficient of the final Young block is constant across a
fixed two-step extension fiber. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_final_diagCoeff_eq
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U V : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    youngAdjacentDiagCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.last n) =
      youngAdjacentDiagCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p V)
        (Fin.last n) := by
  unfold youngAdjacentDiagCoeff
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_axialDistance_eq lam p U V]

/-- The off-diagonal coefficient of the final Young block is constant across a
fixed two-step extension fiber. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_final_offCoeff_eq
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U V : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    youngAdjacentOffCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.last n) =
      youngAdjacentOffCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p V)
        (Fin.last n) := by
  unfold youngAdjacentOffCoeff
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_diagCoeff_eq lam p U V]

/-- Restricting a two-box extension to an earlier entry preserves the row of
that entry in the child tableau. -/
theorem S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_row
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n) :
  ...
  let X := e.symm U
  let T := S05_Lem5_10_twoBoxExtensionTableau lam p U
  have hiter := S05_Lem5_10_iterated_deletion_cellOfEntry_row
    (twoStepFirstChild_isOneBoxChild lam p)
    (twoStepFirstChild_row_form lam p)
    (twoStepSecondChild_isOneBoxChild lam p)
    (twoStepSecondChild_row_form lam p)
...
theorem S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_col
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p))
    (a : Fin n) :
  ...
  let X := e.symm U
  let T := S05_Lem5_10_twoBoxExtensionTableau lam p U
  have hiter := S05_Lem5_10_iterated_deletion_cellOfEntry_col
    (twoStepFirstChild_isOneBoxChild lam p)
    (twoStepFirstChild_row_form lam p)
    (twoStepSecondChild_isOneBoxChild lam p)
    (twoStepSecondChild_row_form lam p)
...
/-- Lemma 5.10 cardinality form of the fixed two-step tableau branching
bijection. -/
theorem S05_Lem5_10_card_twoStepDeletionTableaux_eq_child
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam) :
...
/-- Lemma 5.10 dimension form of the fixed two-step tableau branching
bijection. -/
theorem S05_Lem5_10_tableauDim_fixed_twoStepDeletion
    {n : Nat} (lam : YoungDiagram ((n + 1) + 1))
    (p : TwoStepRemovableRows lam) :
