...
-/
/-!
# Lemma 5.12: Branching dimensions and sign-pattern cardinalities
...
/-- Lemma 5.12: the two-box dimension recursion. -/
theorem S05_Lem5_12_tableauDim_twoStrip_branching_sized
...
/-- Lemma 5.12: the one-box dimension recursion. -/
theorem S05_Lem5_12_tableauDim_oneBox_branching
    {n : Nat} (lam : YoungDiagram (n + 1)) :
    tableauDim lam =
      (oneBoxChildrenSized lam).sum (fun mu => tableauDim mu) :=
  S05_oneBoxDimension_tableauDim_oneBox_branching lam

/-- Lemma 5.12: the even sign-pattern multiset has one entry per tableau. -/
theorem S05_Lem5_12_evenSignPatternMultiset_card :
...
/-- Lemma 5.12: the odd sign-pattern multiset has one entry per tableau. -/
theorem S05_Lem5_12_oddSignPatternMultiset_card
