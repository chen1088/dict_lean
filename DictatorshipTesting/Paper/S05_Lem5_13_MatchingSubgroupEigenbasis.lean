...
-/
/-!
Paper statement: Lemma 5.13 (`lem:matching-restriction-X`)
...
orthogonal, and jointly spanning. Lemma 5.12 supplies the recursive label
...
theorem S05_twoStepExtensionEmbedding_basis
    ...
    S05_twoStepExtensionEmbedding lam p (tableauBasisVec U) =
      tableauBasisVec (S05_Lem5_10_twoBoxExtensionTableau lam p U) := by
  classical
  funext T
...
theorem S05_twoStepExtensionEmbedding_apply_extension
    ...
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    S05_twoStepExtensionEmbedding lam p f
        (S05_Lem5_10_twoBoxExtensionTableau lam p U) =
      f U := by
  classical
  rw [S05_twoStepExtensionEmbedding]
  rw [Fintype.sum_eq_single U]
  ...
  · intro V hVU
    have hExt :
        S05_Lem5_10_twoBoxExtensionTableau lam p V ≠
          S05_Lem5_10_twoBoxExtensionTableau lam p U := by
      intro h
      exact hVU (S05_Lem5_10_twoBoxExtensionTableau_injective lam p h)
...
theorem S05_twoStepExtensionEmbedding_basis_inner
  ...
  · have hExt :
        S05_Lem5_10_twoBoxExtensionTableau lam p U ≠
          S05_Lem5_10_twoBoxExtensionTableau lam p V := by
      intro h
      exact hUV (S05_Lem5_10_twoBoxExtensionTableau_injective lam p h)
...
theorem S05_twoStepExtensionEmbedding_isometry
  ...
  change
    (∑ T : StandardYoungTableau lam,
      S05_twoStepExtensionEmbedding lam p f T *
        (∑ U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p),
          g U * tableauBasisVec
            (S05_Lem5_10_twoBoxExtensionTableau lam p U) T)) =
      ∑ U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p),
        f U * g U
  ...
  have hright :
      (∑ T : StandardYoungTableau lam,
        S05_twoStepExtensionEmbedding lam p f T *
          tableauBasisVec (S05_Lem5_10_twoBoxExtensionTableau lam p U) T) =
        S05_twoStepExtensionEmbedding lam p f
          (S05_Lem5_10_twoBoxExtensionTableau lam p U) := by
    ...
    (∑ T : StandardYoungTableau lam,
        ...
        g U *
          ∑ T : StandardYoungTableau lam,
            S05_twoStepExtensionEmbedding lam p f T *
              tableauBasisVec
                (S05_Lem5_10_twoBoxExtensionTableau lam p U) T := by
          rw [Finset.mul_sum]
          apply Finset.sum_congr rfl
          intro T _hT
          ring
    _ = g U * S05_twoStepExtensionEmbedding lam p f
          (S05_Lem5_10_twoBoxExtensionTableau lam p U) := by rw [hright]
    _ = f U * g U := by
...
theorem S05_twoStepExtensionEmbedding_intertwinesEarlierAdjacent_basis
  ...
  let TU := S05_Lem5_10_twoBoxExtensionTableau lam p U
  rw [S05_twoStepExtensionEmbedding_basis]
  by_cases hrow : adjacentSameRow U a
  · have hrowP : adjacentSameRow TU (Fin.castSucc (Fin.castSucc a)) :=
      (S05_Lem5_10_twoBoxExtensionTableau_earlier_sameRow_iff
        lam p U a).2 hrow
  ...
  · by_cases hcol : adjacentSameCol U a
    · have hcolP : adjacentSameCol TU (Fin.castSucc (Fin.castSucc a)) :=
        (S05_Lem5_10_twoBoxExtensionTableau_earlier_sameCol_iff
          lam p U a).2 hcol
    ...
    · have hrowP : ¬ adjacentSameRow TU (Fin.castSucc (Fin.castSucc a)) := by
      ...
      have hswap :
          S05_Lem5_10_twoBoxExtensionTableau lam p U' =
            adjacentSwapTableau TU (Fin.castSucc (Fin.castSucc a))
              hrowP hcolP := by
        simpa [TU, U'] using
          S05_Lem5_10_twoBoxExtensionTableau_earlier_swap
            lam p U a hrow hcol
      ...
      rw [S05_Lem5_10_twoBoxExtensionTableau_earlier_diagCoeff,
        S05_Lem5_10_twoBoxExtensionTableau_earlier_offCoeff,
        ← hswap]
...
theorem S05_twoStepExtensionEmbedding_operator_expansion
  ...
  change youngAdjacentOperator a
      (fun T =>
        ∑ U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p),
          f U * tableauBasisVec
            (S05_Lem5_10_twoBoxExtensionTableau lam p U) T) = _
  rw [youngAdjacentOperator_sum]
  funext T
  apply Finset.sum_congr rfl
  intro U _hU
...
theorem S05_twoBoxExtension_final_diagCoeff
    ...
    (p : TwoStepRemovableRows lam)
    (U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p)) :
    youngAdjacentDiagCoeff (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.last n) =
      S05_twoBoxFinalDiagCoeff lam p := by
  unfold youngAdjacentDiagCoeff adjacentAxialDistance entryContent
  change
    (((YoungCell.content
        (adjacentHiCell (S05_Lem5_10_twoBoxExtensionTableau lam p U)
          (Fin.last n)) -
      YoungCell.content
        (adjacentLoCell (S05_Lem5_10_twoBoxExtensionTableau lam p U)
          (Fin.last n)) : Int) : Real)⁻¹ =
      S05_twoBoxFinalDiagCoeff lam p)
  rw [S05_Lem5_10_twoBoxExtensionTableau_final_hiCell,
    S05_Lem5_10_twoBoxExtensionTableau_final_loCell]
  rfl
...
theorem S05_signedTwoBoxExtensionBasisVector_eq_plusProjection
    ...
    (hrow : ¬ adjacentSameRow
      (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n)) :
  ...
  · by_cases hrow : adjacentSameRow
    ...
    · rw [S05_signedTwoBoxExtensionBasisVector]
      ...
      rw [youngAdjacentOperator_basis_sameRow
        (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) hrow]
    ...
    · have hcol := S05_twoBoxExtension_not_sameCol_of_positive lam p hpos U
      ...
      rw [S05_normalizedAdjacentPlusVector_eigen
        (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) hrow hcol]
      simp [S05_signedTwoBoxRemovalSign, hpos]
...
theorem S05_twoBoxExtension_finalSwap_ne_extension_of_ne
    ...
    (hcol : ¬ adjacentSameCol
      (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n)) :
    adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        (Fin.last n)
        (by simpa [adjacentSameRow] using hrow)
        (by simpa [adjacentSameCol] using hcol) ≠
      S05_Lem5_10_twoBoxExtensionTableau lam p V := by
  ...
  · rw [S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_row,
      S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_row]
  ...
  · rw [S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_col,
      S05_Lem5_10_twoBoxExtensionTableau_child_cellOfEntry_col]
    have hfix := S05_Lem5_01_adjacentSwapTableau_cell_of_ne_lo_hi
      (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n)
      (by simpa [adjacentSameRow] using hrow)
      (by simpa [adjacentSameCol] using hcol)
...
theorem S05_twoBoxExtension_finalSwap_ne_finalSwap_of_ne
    ...
    (hrowV : ¬ adjacentSameRow
      (S05_Lem5_10_twoBoxExtensionTableau lam p V) (Fin.last n))
    ...
    adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p U)
      ...
      adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p V)
        (Fin.last n)
  ...
  have hfixV := S05_Lem5_01_adjacentSwapTableau_cell_of_ne_lo_hi
    ...
    (S05_castCastSucc_ne_final_hi a)
  have hparent :
      cellOfEntry (S05_Lem5_10_twoBoxExtensionTableau lam p U)
          (Fin.castSucc (Fin.castSucc a)) =
        cellOfEntry (S05_Lem5_10_twoBoxExtensionTableau lam p V)
...
theorem S05_twoBoxExtension_ne_of_removal_ne
    ...
    S05_Lem5_10_twoBoxExtensionTableau lam p U ≠
      S05_Lem5_10_twoBoxExtensionTableau lam q V := by
  intro hExt
  apply hpq
  apply twoStepRemovableRows_ext
  · have hhi := congrArg
      (fun T => YoungCell.row (adjacentHiCell T (Fin.last n))) hExt
    rw [S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row] at hhi
    exact hhi
  · have hlo := congrArg
      (fun T => YoungCell.row (adjacentLoCell T (Fin.last n))) hExt
    rw [S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row] at hlo
    exact hlo
...
theorem S05_twoBoxExtension_finalSwap_rows_of_eq_extension
    ...
    (hEq :
      adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        ...
        S05_Lem5_10_twoBoxExtensionTableau lam q V) :
  ...
  · have hhi := congrArg
    ...
    change YoungCell.row
        (cellOfEntry
          (adjacentSwapTableau
            (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) _ _)
          (adjacentEntryHi (Fin.last n))) = _ at hhi
    rw [S05_Lem5_01_adjacentSwapTableau_cell_hi,
      S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row] at hhi
    exact hhi
  · have hlo := congrArg
    ...
    rw [S05_Lem5_01_adjacentSwapTableau_cell_lo,
      S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row] at hlo
    exact hlo
...
theorem S05_twoBoxExtension_finalSwap_ne_extension_of_positive
  ...
  have hne : p.second.1 ≠ p.first.1 := by
    intro h
    exact hrowP
      ((S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff
        lam p U).2 h)
  omega
...
theorem S05_twoBoxExtension_finalSwap_ne_finalSwap_of_removal_ne
    ...
    (hrowQ : ¬ adjacentSameRow
      (S05_Lem5_10_twoBoxExtensionTableau lam q V) (Fin.last n))
    ...
    adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam p U)
        ...
        (by simpa [adjacentSameRow] using hrowP)
        (by simpa [adjacentSameCol] using hcolP) ≠
      adjacentSwapTableau (S05_Lem5_10_twoBoxExtensionTableau lam q V)
        (Fin.last n)
  ...
  · have hlo := congrArg
    ...
    change YoungCell.row
      ...
      YoungCell.row
        (cellOfEntry
          (adjacentSwapTableau
            (S05_Lem5_10_twoBoxExtensionTableau lam q V) (Fin.last n) _ _)
          (adjacentEntryLo (Fin.last n))) at hlo
    rw [S05_Lem5_01_adjacentSwapTableau_cell_lo,
      S05_Lem5_01_adjacentSwapTableau_cell_lo,
      S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_hiCell_row] at hlo
    exact hlo
  · have hhi := congrArg
      (fun T => YoungCell.row (adjacentHiCell T (Fin.last n))) hEq
    change YoungCell.row
    ...
    rw [S05_Lem5_01_adjacentSwapTableau_cell_hi,
      ...
      S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row,
      S05_Lem5_10_twoBoxExtensionTableau_final_loCell_row] at hhi
    exact hhi
...
theorem S05_signedTwoBoxExtensionBasisVector_inner_of_distinct_positive
  ...
  let TP := S05_Lem5_10_twoBoxExtensionTableau lam p U
  let TQ := S05_Lem5_10_twoBoxExtensionTableau lam q V
  ...
  · have hrowP : adjacentSameRow TP (Fin.last n) := by
      exact (S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff
        lam p U).2 hrowsP
...
theorem S05_signedTwoBoxExtensionBasisVector_inner_of_distinct_negative
  ...
  · have hcolP : adjacentSameCol TP (Fin.last n) := by
      exact (S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff
        lam p U).2 hcolsP
    by_cases hcolsQ :
    ...
    · have hcolQ : ¬ adjacentSameCol TQ (Fin.last n) := by
        intro h
        exact hcolsQ
          ((S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff
            lam q V).1 h)
      have hTP_swapQ : TP ≠ adjacentSwapTableau TQ (Fin.last n)
          (by simpa [adjacentSameRow] using hrowQ)
          (by simpa [adjacentSameCol] using hcolQ) := by
...
theorem S05_signedTwoBoxExtensionBasisVector_inner
  ...
  · rw [if_neg hUV]
    let TU := S05_Lem5_10_twoBoxExtensionTableau lam p U
    let TV := S05_Lem5_10_twoBoxExtensionTableau lam p V
    ...
    · by_cases hrowU : adjacentSameRow TU (Fin.last n)
      · have hrowV : adjacentSameRow TV (Fin.last n) :=
          (S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff lam p V).2
            ((S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff lam p U).1
      ...
      · have hrowV : ¬ adjacentSameRow TV (Fin.last n) := by
          ...
          apply hrowU
          simpa [TU] using
            (S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff lam p U).2
              ((S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff lam p V).1
                (by simpa [TV] using h))
    ...
    · have hrowU : ¬ adjacentSameRow TU (Fin.last n) := by
      ...
      · have hcolV : adjacentSameCol TV (Fin.last n) :=
          (S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff lam p V).2
            ((S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff lam p U).1
      ...
      · have hcolV : ¬ adjacentSameCol TV (Fin.last n) := by
          ...
          apply hcolU
          simpa [TU] using
            (S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff lam p U).2
              ((S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff lam p V).1
                (by simpa [TV] using h))
        have hTU_swapV : TU ≠ adjacentSwapTableau TV (Fin.last n)
            (by simpa [adjacentSameRow] using hrowV)
            (by simpa [adjacentSameCol] using hcolV) := by
...
theorem S05_signedTwoBoxChildEmbedding_eq_raw_of_positive_sameRow
  ...
  have hrowU : adjacentSameRow
      (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) :=
    (S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff lam p U).2 hrow
  rw [S05_signedTwoBoxExtensionBasisVector]
  dsimp only
...
theorem S05_signedTwoBoxChildEmbedding_eq_raw_of_negative_sameCol
  ...
  have hcolU : adjacentSameCol
      (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) :=
    (S05_Lem5_10_twoBoxExtensionTableau_final_sameCol_iff lam p U).2 hcol
  rw [S05_signedTwoBoxExtensionBasisVector]
  dsimp only
...
theorem S05_signedTwoBoxChildEmbedding_eq_plusProjection
  ...
  calc
    _ = ∑ U : StandardYoungTableau (deleteTwoRemovableRowsDiagram lam p),
      ...
      intro U _hU
      have hrowU : ¬ adjacentSameRow
          (S05_Lem5_10_twoBoxExtensionTableau lam p U) (Fin.last n) := by
        intro hp
        exact hrow
          ((S05_Lem5_10_twoBoxExtensionTableau_final_sameRow_iff
            lam p U).1 hp)
...
theorem S05_Lem5_13_canonicalEvenMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * (m + 1))) :
...
theorem S05_canonicalEvenMatchingBasis_character_action
  ...
  exact canonicalMatchingCubeOperatorEven_apply_character_of_isMatchingEigenvector
    ((S05_Lem5_13_canonicalEvenMatchingEigenbasis m lam).2.1 i) x
...
label multiset. -/
theorem S05_Lem5_13_canonicalOddMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
      tableauInner
          (S05_canonicalOddMatchingBasis m lam i)
...
theorem S05_canonicalOddMatchingBasis_character_action
  ...
  exact canonicalMatchingCubeOperatorOdd_apply_character_of_isMatchingEigenvector
    ((S05_Lem5_13_canonicalOddMatchingEigenbasis m lam).2.2.1 i) x
...
theorem S05_arbitraryEvenMatchingBasis_inner
  ...
  exact (S05_Lem5_13_canonicalEvenMatchingEigenbasis m lam).1 i j
...
theorem S05_Lem5_13_arbitraryEvenMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * (m + 1)))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * (m + 1))) :
    (∀ i j : S05_CanonicalEvenEigenbasisIndex (m + 1) lam,
...
theorem S05_Lem5_13_arbitraryEvenMatchingEigenbasis_toOrdered
    (m : Nat) (lam : YoungDiagram (2 * (m + 1)))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * (m + 1))) :
    (∀ i j : S05_CanonicalEvenEigenbasisIndex (m + 1) lam,
...
theorem S05_arbitraryOddMatchingBasis_inner
  ...
  exact (S05_Lem5_13_canonicalOddMatchingEigenbasis m lam).1 i j
...
theorem S05_Lem5_13_arbitraryOddMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * m + 1))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
...
theorem S05_Lem5_13_arbitraryOddMatchingEigenbasis_toOrdered
    (m : Nat) (lam : YoungDiagram (2 * m + 1))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
...
/-- Lemma 5.13 matching-operator component: a canonical even matching edge
operator is an involution. -/
theorem S05_Lem5_13_canonicalMatchingYoungOperatorEven_involutive
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 matching-operator component: distinct canonical even matching
edge operators commute. -/
theorem S05_Lem5_13_canonicalMatchingYoungOperatorEven_comm
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 matching-operator component: a canonical odd matching edge
operator is an involution. -/
theorem S05_Lem5_13_canonicalMatchingYoungOperatorOdd_involutive
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
...
/-- Lemma 5.13 matching-operator component: distinct canonical odd matching
edge operators commute. -/
theorem S05_Lem5_13_canonicalMatchingYoungOperatorOdd_comm
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.13 matching-edge eigenspace component: `v + A_r v` is a `+1`
eigenvector for an even matching edge. -/
theorem S05_Lem5_13_matchingEdge_plusEigenVec_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.13 matching-edge eigenspace component: `v - A_r v` is a `-1`
eigenvector for an even matching edge. -/
theorem S05_Lem5_13_matchingEdge_minusEigenVec_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
        (fun T => f T - canonicalMatchingYoungOperatorEven r f T) =
...
theorem S05_Lem5_13_matchingEdge_plusEigenVec_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.13 matching-edge eigenspace component: `v - A_r v` is a `-1`
eigenvector for an odd matching edge. -/
theorem S05_Lem5_13_matchingEdge_minusEigenVec_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
        (fun T => f T - canonicalMatchingYoungOperatorOdd r f T) =
...
/-- Lemma 5.13 matching-cube component: the odd canonical matching operators
respect the cube XOR law. -/
...
/-- Lemma 5.13 matching-cube component: the even canonical matching-cube
...
/-- Lemma 5.13 matching-cube component: the odd canonical matching-cube
operator is the fixed ordered product of the selected edge operators. -/
...
/-- Lemma 5.13 matching-character component: on an even simultaneous
...
/-- Lemma 5.13 matching-character component: on an odd simultaneous
matching-edge eigenspace, the cube action is the product of selected edge
signs. -/
...
/-- Lemma 5.13 projection component: the one-edge even plus projection lands in
the `+1` eigenspace of that edge. -/
theorem S05_Lem5_13_matchingEdgePlusProjectionEven_isPlusEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.13 projection component: the one-edge even minus projection lands
in the `-1` eigenspace of that edge. -/
theorem S05_Lem5_13_matchingEdgeMinusProjectionEven_isMinusEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.13 projection component: the one-edge odd plus projection lands in
the `+1` eigenspace of that edge. -/
theorem S05_Lem5_13_matchingEdgePlusProjectionOdd_isPlusEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.13 projection component: the one-edge odd minus projection lands
in the `-1` eigenspace of that edge. -/
theorem S05_Lem5_13_matchingEdgeMinusProjectionOdd_isMinusEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.13 projection component: projecting to the `+1` eigenspace of one
even matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_13_matchingEdgePlusProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 projection component: projecting to the `-1` eigenspace of one
even matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_13_matchingEdgeMinusProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorEven s f = c • f) :
...
theorem S05_Lem5_13_matchingEdgePlusProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
...
/-- Lemma 5.13 projection component: projecting to the `-1` eigenspace of one
odd matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_13_matchingEdgeMinusProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorOdd s f = c • f) :
...
/-- Lemma 5.13 projection component: the sign-selected even one-edge
projection has the edge eigenvalue prescribed by the support. -/
theorem S05_Lem5_13_matchingEdgeSignProjectionEven_isMatchingEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 projection component: the sign-selected odd one-edge projection
has the edge eigenvalue prescribed by the support. -/
theorem S05_Lem5_13_matchingEdgeSignProjectionOdd_isMatchingEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (R : Finset (Fin m)) (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.13 projection component: the sign-selected even one-edge projection
preserves every other edge eigenvalue. -/
theorem S05_Lem5_13_matchingEdgeSignProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 projection component: the sign-selected odd one-edge projection
preserves every other edge eigenvalue. -/
theorem S05_Lem5_13_matchingEdgeSignProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (R : Finset (Fin m)) {r s : Fin m} (hrs : r ≠ s)
    {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorOdd s f = c • f) :
...
/-- Lemma 5.13 projection component: the iterated even support-selected
...
theorem S05_Lem5_13_matchingEdge_basis_sameRow_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.13 one-edge component: an even matching edge negates a same-column
tableau basis vector. -/
theorem S05_Lem5_13_matchingEdge_basis_sameCol_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.13 one-edge eigenspace component: in the even case, a same-row
tableau basis vector has eigenvalue `1`. -/
theorem S05_Lem5_13_matchingEdge_sameRow_eigen_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow : adjacentSameRow T (canonicalMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorEven r (tableauBasisVec T) =
...
/-- Lemma 5.13 one-edge eigenspace component: in the even case, a same-column
tableau basis vector has eigenvalue `-1`. -/
theorem S05_Lem5_13_matchingEdge_sameCol_eigen_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hcol : adjacentSameCol T (canonicalMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorEven r (tableauBasisVec T) =
...
/-- Lemma 5.13 one-edge component: in an even swappable edge, the diagonal
coordinate is the Young axial coefficient. -/
theorem S05_Lem5_13_matchingEdge_basis_swappable_self_value_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.13 one-edge component: in an even swappable edge, the swapped
coordinate is the Young off-diagonal coefficient. -/
theorem S05_Lem5_13_matchingEdge_basis_swappable_swap_value_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow_ne : ¬ adjacentSameRow T (canonicalMatchingAdjacentIndex m r))
    (hcol_ne : ¬ adjacentSameCol T (canonicalMatchingAdjacentIndex m r)) :
...
/-- Lemma 5.13 one-edge component: an odd matching edge fixes a same-row
tableau basis vector. -/
theorem S05_Lem5_13_matchingEdge_basis_sameRow_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.13 one-edge component: an odd matching edge negates a same-column
tableau basis vector. -/
theorem S05_Lem5_13_matchingEdge_basis_sameCol_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.13 one-edge eigenspace component: in the odd case, a same-row
tableau basis vector has eigenvalue `1`. -/
theorem S05_Lem5_13_matchingEdge_sameRow_eigen_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow : adjacentSameRow T (canonicalNearMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorOdd r (tableauBasisVec T) =
...
/-- Lemma 5.13 one-edge eigenspace component: in the odd case, a same-column
tableau basis vector has eigenvalue `-1`. -/
theorem S05_Lem5_13_matchingEdge_sameCol_eigen_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hcol : adjacentSameCol T (canonicalNearMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorOdd r (tableauBasisVec T) =
...
/-- Lemma 5.13 one-edge component: in an odd swappable edge, the diagonal
coordinate is the Young axial coefficient. -/
theorem S05_Lem5_13_matchingEdge_basis_swappable_self_value_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.13 one-edge component: in an odd swappable edge, the swapped
coordinate is the Young off-diagonal coefficient. -/
theorem S05_Lem5_13_matchingEdge_basis_swappable_swap_value_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow_ne : ¬ adjacentSameRow T (canonicalNearMatchingAdjacentIndex m r))
    (hcol_ne : ¬ adjacentSameCol T (canonicalNearMatchingAdjacentIndex m r)) :
...
theorem S05_Lem5_13_highLabelCount_of_evenSignPatternMultiset
    {m : Nat} {lam : YoungDiagram (2 * m)}
    {ι : Type*} [Fintype ι]
...
multiset, its high-label count is the active tableau height. -/
theorem S05_Lem5_13_highLabelCount_of_oddSignPatternMultiset
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {ι : Type*} [Fintype ι]
    (label : ι -> Finset (Fin m))
