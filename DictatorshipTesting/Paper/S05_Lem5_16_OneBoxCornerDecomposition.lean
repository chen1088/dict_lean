...
/-!
Paper statement: Lemma 5.16 (`lem:one-box-corner-decomposition`)
...
theorem S05_Lem5_16_row_form_unique
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) :
    ∃! r : Nat,
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_16_removable_row
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) :
    exists r : Nat,
      IsRemovableRow lam r ∧
...
theorem S05_Lem5_16_removable_corner
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) :
    exists u : Nat × Nat,
      IsRemovableCornerBox lam u ∧
...
or the deleted cell. -/
theorem S05_Lem5_16_parent_cell_iff_child_cell_or_deleted
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
...
theorem S05_Lem5_16_child_cell_iff_parent_cell_not_deleted
    {n k : Nat} {lam : YoungDiagram n} {mu : YoungDiagram k}
    (h : IsOneBoxChild lam mu) {r s c : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_16_tableau_max_removable_corner {n : Nat}
    {lam : YoungDiagram (n + 1)} (T : StandardYoungTableau lam)
    {u : YoungCell lam} (hu : TableauMaxAt T u) :
    IsRemovableCornerBox lam (YoungCell.toNatPair u) := by
...
theorem S05_Lem5_16_tableau_unique_removable_corner {n : Nat}
    {lam : YoungDiagram (n + 1)} (T : StandardYoungTableau lam) :
    ∃! u : YoungCell lam,
      TableauMaxAt T u ∧ IsRemovableCornerBox lam (YoungCell.toNatPair u) := by
