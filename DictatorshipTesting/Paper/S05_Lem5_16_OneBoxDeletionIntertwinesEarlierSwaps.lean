...
theorem S05_Lem5_16_childCellToParent_cellOfEntry_deleteMax
...
theorem S05_Lem5_16_deleteMax_cellOfEntry_row
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_16_deleteMax_cellOfEntry_col
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_16_deleteMax_entryContent
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
theorem S05_Lem5_16_deleteMax_tableauContentSequence
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
...
one-box insertion. -/
theorem S05_Lem5_16_castSucc_adjacentEntryLo
    {n : Nat} (a : Fin n) :
...
one-box insertion. -/
theorem S05_Lem5_16_castSucc_adjacentEntryHi
    {n : Nat} (a : Fin n) :
...
theorem S05_Lem5_16_insertMax_adjacentLoCell_row
  ...
  have hrow := S05_Lem5_16_deleteMax_cellOfEntry_row h hr
    ...
    (adjacentEntryLo a)
  have hdel := S05_Lem5_15_delete_insert h hr S
  simp [S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow,
    hdel] at hrow
  rw [S05_Lem5_16_castSucc_adjacentEntryLo a] at hrow
  simpa [adjacentLoCell,
    S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow] using hrow
...
theorem S05_Lem5_16_insertMax_adjacentLoCell_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    YoungCell.col (adjacentLoCell S a) =
      YoungCell.col
        (adjacentLoCell
          (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow
            h hr S) (Fin.castSucc a)) := by
  have hcol := S05_Lem5_16_deleteMax_cellOfEntry_col h hr
    (deletedCornerCellOfOneBoxChildRow h hr)
    (deletedCornerCell_row h hr)
    (deletedCornerCell_col h hr)
    (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S)
  ...
  simp [S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow,
    hdel] at hcol
  rw [S05_Lem5_16_castSucc_adjacentEntryLo a] at hcol
  simpa [adjacentLoCell,
    S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow] using hcol

/-- Lemma 5.16 row component: inserting the maximum box preserves the row of
the upper entry in every earlier adjacent pair. -/
theorem S05_Lem5_16_insertMax_adjacentHiCell_row
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  simp [S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow,
    hdel] at hrow
  rw [S05_Lem5_16_castSucc_adjacentEntryHi a] at hrow
  simpa [adjacentHiCell,
    S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow] using hrow

/-- Lemma 5.16 column component: inserting the maximum box preserves the
column of the upper entry in every earlier adjacent pair. -/
theorem S05_Lem5_16_insertMax_adjacentHiCell_col
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
...
theorem S05_Lem5_16_insertMax_adjacentSameRow_iff
  ...
  constructor
  · intro hrow
    have hlo := S05_Lem5_16_insertMax_adjacentLoCell_row h hr S a
    have hhi := S05_Lem5_16_insertMax_adjacentHiCell_row h hr S a
...
theorem S05_Lem5_16_insertMax_adjacentSameCol_iff
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  constructor
  · intro hcol
    have hlo := S05_Lem5_16_insertMax_adjacentLoCell_col h hr S a
    have hhi := S05_Lem5_16_insertMax_adjacentHiCell_col h hr S a
...
theorem S05_Lem5_16_insertMax_entryContent_castSucc
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
    ...
    entryContent S a =
      entryContent
        (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow
          h hr S) (Fin.castSucc a) := by
  have hcontent := S05_Lem5_16_deleteMax_entryContent h hr
    (deletedCornerCellOfOneBoxChildRow h hr)
    (deletedCornerCell_row h hr)
    (deletedCornerCell_col h hr)
    (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S)
...
theorem S05_Lem5_16_insertMax_adjacentAxialDistance
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  rw [S05_Lem5_16_insertMax_entryContent_castSucc h hr S (adjacentEntryHi a)]
  rw [S05_Lem5_16_insertMax_entryContent_castSucc h hr S (adjacentEntryLo a)]
  rw [S05_Lem5_16_castSucc_adjacentEntryHi a]
  rw [S05_Lem5_16_castSucc_adjacentEntryLo a]
...
theorem S05_Lem5_16_insertMax_youngAdjacentDiagCoeff
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  rw [youngAdjacentDiagCoeff, youngAdjacentDiagCoeff,
    S05_Lem5_16_insertMax_adjacentAxialDistance h hr S a]
...
theorem S05_Lem5_16_insertMax_youngAdjacentOffCoeff
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  rw [youngAdjacentOffCoeff, youngAdjacentOffCoeff,
    S05_Lem5_16_insertMax_youngAdjacentDiagCoeff h hr S a]

/-- Reindexing helper: value swaps commute with adding a new maximum value
above the adjacent pair. -/
theorem S05_Lem5_16_adjacentSwapValue_castSucc
  ...
  · subst x
    rw [adjacentSwapValue_lo,
      S05_Lem5_16_castSucc_adjacentEntryHi,
      S05_Lem5_16_castSucc_adjacentEntryLo,
...
maximum value. -/
theorem S05_Lem5_16_adjacentSwapValue_last_castSucc
    {n : Nat} (a : Fin n) :
...
theorem S05_Lem5_16_insertMax_adjacentSwapTableau
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr
    ...
    adjacentSwapTableau
      ...
      (by
        intro hp
        exact hrow_ne
          ((S05_Lem5_16_insertMax_adjacentSameRow_iff h hr S a).1 hp))
      (by
        intro hp
        exact hcol_ne
          ((S05_Lem5_16_insertMax_adjacentSameCol_iff h hr S a).1 hp)) := by
  ...
  · subst u
    change
      ...
      adjacentSwapEntry
        ...
        (Fin.castSucc a)
        (deletedCornerCellOfOneBoxChildRow h hr)
    rw [S05_Lem5_15_insertMax_entry_deletedCorner,
      adjacentSwapEntry, S05_Lem5_15_insertMax_entry_deletedCorner,
      S05_Lem5_16_adjacentSwapValue_last_castSucc]
  · change
      (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr
    ...
    have hleft :
      ...
      simpa [v] using
        S05_Lem5_15_insertMax_entry_ne_deletedCorner
    ...
    have hright :
      ...
      congr
      simpa [v] using
        S05_Lem5_15_insertMax_entry_ne_deletedCorner h hr S u hu
    rw [hleft, hright]
    simpa [adjacentSwapTableau, adjacentSwapEntry] using
      S05_Lem5_16_adjacentSwapValue_castSucc a (S.entry v)

/-- Lemma 5.16 basis component: one-box insertion is injective on standard
tableaux of the child shape. -/
theorem S05_Lem5_16_insertMax_injective
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
    ...
    (hST :
      S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S =
        S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T) :
    S = T := by
  let e :=
    S05_Lem5_15_oneBoxDeletionTableauxEquivChildTableauxOfOneBoxChildRow h hr
  have hsub : e.symm S = e.symm T := by
    ...
    simpa [S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow]
      using hST
...
theorem S05_Lem5_16_insertMax_youngAdjacentMatrixCoeff
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
  ...
  · have hrowP :
        adjacentSameRow
          (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T)
          (Fin.castSucc a) :=
      (S05_Lem5_16_insertMax_adjacentSameRow_iff h hr T a).2 hrowT
    by_cases hST : S = T
    · subst S
      rw [youngAdjacentMatrixCoeff_sameRow_self
          (T := S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow
            h hr T) (a := Fin.castSucc a) hrowP,
        youngAdjacentMatrixCoeff_sameRow_self (T := T) (a := a) hrowT]
    · have hPST :
          S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S ≠
            S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T := by
        intro hp
        exact hST (S05_Lem5_16_insertMax_injective h hr hp)
  ...
  · by_cases hcolT : adjacentSameCol T a
    · have hcolP :
          adjacentSameCol
            (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T)
            (Fin.castSucc a) :=
        (S05_Lem5_16_insertMax_adjacentSameCol_iff h hr T a).2 hcolT
      by_cases hST : S = T
      · subst S
    ...
    · have hrowP :
        ...
        intro hp
        exact hrowT
          ((S05_Lem5_16_insertMax_adjacentSameRow_iff h hr T a).1 hp)
      have hcolP :
          ¬ adjacentSameCol
            (S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T)
            (Fin.castSucc a) := by
        intro hp
        exact hcolT
          ((S05_Lem5_16_insertMax_adjacentSameCol_iff h hr T a).1 hp)
      by_cases hST : S = T
      · subst S
        rw [youngAdjacentMatrixCoeff_swappable_self
          ...
          ← S05_Lem5_16_insertMax_youngAdjacentDiagCoeff h hr T a]
      · by_cases hSswap : S = adjacentSwapTableau T a hrowT hcolT
        · subst S
          have hswap :=
            S05_Lem5_16_insertMax_adjacentSwapTableau h hr T a hrowT hcolT
          rw [hswap,
            ...
            youngAdjacentMatrixCoeff_swappable_swap (T := T) (a := a)
              hrowT hcolT,
            ← S05_Lem5_16_insertMax_youngAdjacentOffCoeff h hr T a]
        · have hPST :
              S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S ≠
                S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T := by
            intro hp
          ...
          have hPswap :
            ...
            exact hSswap (S05_Lem5_16_insertMax_injective h hr hp')
...
deletion fiber. -/
def S05_Lem5_16_deletionFiberYoungAdjacentOperator
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    S05_Lem5_15_OneBoxDeletionCoordinateSpace h hr :=
  fun S =>
...
theorem S05_Lem5_16_deletionCoordinateMap_youngAdjacentOperator_intertwines
    {n : Nat} {lam : YoungDiagram ((n + 1) + 1)}
    {mu : YoungDiagram (n + 1)}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
    ...
    youngAdjacentOperator a
      ...
      =
    S05_Lem5_15_deletionCoordinateMap h hr
      (S05_Lem5_16_deletionFiberYoungAdjacentOperator h hr a f) := by
  classical
  funext S
  let e :=
    S05_Lem5_15_oneBoxDeletionTableauxEquivChildTableauxOfOneBoxChildRow h hr
        ...
        change
          youngAdjacentMatrixCoeff a S T =
            youngAdjacentMatrixCoeff (Fin.castSucc a)
              (insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr S)
              (insertMaxAsStandardYoungTableauOfOneBoxChildRow h hr T)
        simpa [S05_Lem5_15_insertMaxAsStandardYoungTableauOfOneBoxChildRow] using
          (S05_Lem5_16_insertMax_youngAdjacentMatrixCoeff h hr S T a).symm
      rw [hcoeff])
...
theorem S05_Lem5_16_deletionCoordinateMap_diagonalContent_intertwines
    {n : Nat} {lam : YoungDiagram (n + 1)} {mu : YoungDiagram n}
    (h : IsOneBoxChild lam mu) {r : Nat}
    (hr :
      youngRow lam r = youngRow mu r + 1 ∧
  ...
  have hdel :
    ...
    exact S05_Lem5_16_deleteMax_entryContent h hr
      (deletedCornerCellOfOneBoxChildRow h hr)
      (deletedCornerCell_row h hr)
      (deletedCornerCell_col h hr)
      (e.symm S).1 (e.symm S).2 a
