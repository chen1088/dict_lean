...
/-!
Paper statement: Lemma 5.17 (`lem:X-size`)
...
theorem S05_Lem5_17_evenHighSignPatternCount_succ
    (m : Nat) (lam : YoungDiagram (2 * (m + 1))) :
...
theorem S05_Lem5_17_oddHighSignPatternCount_eq_evenHigh_sum
    (m : Nat) (lam : YoungDiagram (2 * m + 1)) :
...
theorem S05_Lem5_17_youngDim_twoStrip_size
...
cases. -/
theorem S05_Lem5_17_youngDim_oneBox_size
