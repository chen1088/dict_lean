...
import DictatorshipTesting.Paper.S05_Lem5_19_SizesOfTheSignPatternMultisets
...
/-!
Paper statement: Lemma 5.20 (`lem:matching-restriction-X`)
...
spanning. Definitions 5.13--5.14 and Lemma 5.19 provide the genuine recursive
...
theorem S05_card_canonicalEvenEigenbasisIndex
  ...
  calc
    ...
    _ = Fintype.card (StandardYoungTableau lam) := by
      have h := S05_Lem5_19_evenSignPatternMultiset_card m lam
...
theorem S05_Lem5_20_canonicalEvenMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * (m + 1))) :
...
theorem S05_canonicalEvenMatchingBasis_character_action
  ...
  exact canonicalMatchingCubeOperatorEven_apply_character_of_isMatchingEigenvector
    ((S05_Lem5_20_canonicalEvenMatchingEigenbasis m lam).2.1 i) x
...
theorem S05_oneBoxExtensionTableau_maxRemovableRow
  ...
  exact S05_Lem5_15_insertMax_tableauMaxAt_deletedCorner
    (removableRowToOneBoxChild_isOneBoxChild lam r)
    (row_form_deleteRemovableRowDiagram lam r.2) U
...
theorem S05_oneBoxExtensionTableau_injective
  ...
  intro U V hUV
  exact S05_Lem5_16_insertMax_injective
    (removableRowToOneBoxChild_isOneBoxChild lam r)
...
theorem S05_oneBoxExtensionEmbedding_intertwinesEarlierAdjacent_basis
  ...
  · have hrowP : adjacentSameRow TU (Fin.castSucc a) := by
      exact (S05_Lem5_16_insertMax_adjacentSameRow_iff h hr U a).2 hrow
    rw [youngAdjacentOperator_basis_sameRow TU _ hrowP,
      youngAdjacentOperator_basis_sameRow U a hrow,
      S05_oneBoxExtensionEmbedding_basis]
  · by_cases hcol : adjacentSameCol U a
    · have hcolP : adjacentSameCol TU (Fin.castSucc a) := by
        exact (S05_Lem5_16_insertMax_adjacentSameCol_iff h hr U a).2 hcol
      rw [youngAdjacentOperator_basis_sameCol TU _ hcolP,
        youngAdjacentOperator_basis_sameCol U a hcol]
      have hnegP : (fun S => -tableauBasisVec TU S) =
          (-1 : Real) • tableauBasisVec TU := by
    ...
    · have hrowP : ¬ adjacentSameRow TU (Fin.castSucc a) := by
        intro hp
        exact hrow ((S05_Lem5_16_insertMax_adjacentSameRow_iff h hr U a).1 hp)
      have hcolP : ¬ adjacentSameCol TU (Fin.castSucc a) := by
        intro hp
        exact hcol ((S05_Lem5_16_insertMax_adjacentSameCol_iff h hr U a).1 hp)
      let U' := adjacentSwapTableau U a hrow hcol
      have hswap :
          S05_oneBoxExtensionTableau lam r U' =
            adjacentSwapTableau TU (Fin.castSucc a) hrowP hcolP := by
        simpa [TU, U', h, hr, S05_oneBoxExtensionTableau] using
          S05_Lem5_16_insertMax_adjacentSwapTableau h hr U a hrow hcol
      rw [youngAdjacentOperator_basis_swappable_eq TU _ hrowP hcolP,
        youngAdjacentOperator_basis_swappable_eq U a hrow hcol]
      have hchild :
          (fun S => youngAdjacentDiagCoeff U a * tableauBasisVec U S +
      ...
      have hdiag :
        ...
        simpa [TU, S05_oneBoxExtensionTableau] using
          (S05_Lem5_16_insertMax_youngAdjacentDiagCoeff h hr U a).symm
      have hoff :
          youngAdjacentOffCoeff TU (Fin.castSucc a) =
            youngAdjacentOffCoeff U a := by
        simpa [TU, S05_oneBoxExtensionTableau] using
          (S05_Lem5_16_insertMax_youngAdjacentOffCoeff h hr U a).symm
      rw [hdiag, hoff, ← hswap]
...
label multiset. -/
theorem S05_Lem5_20_canonicalOddMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
      tableauInner
          (S05_canonicalOddMatchingBasis m lam i)
...
theorem S05_canonicalOddMatchingBasis_character_action
  ...
  exact canonicalMatchingCubeOperatorOdd_apply_character_of_isMatchingEigenvector
    ((S05_Lem5_20_canonicalOddMatchingEigenbasis m lam).2.2.1 i) x
...
theorem S05_arbitraryEvenMatchingBasis_inner
  ...
  exact (S05_Lem5_20_canonicalEvenMatchingEigenbasis m lam).1 i j
...
theorem S05_Lem5_20_arbitraryEvenMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * (m + 1)))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * (m + 1))) :
    (∀ i j : S05_CanonicalEvenEigenbasisIndex (m + 1) lam,
...
theorem S05_arbitraryEvenMatchingBasis_highLabelCount
  ...
  exact S05_Lem5_19_highLabelCount_of_evenSignPatternMultiset
    (S05_canonicalEvenEigenbasisLabel m lam)
...
theorem S05_Lem5_20_arbitraryEvenMatchingEigenbasis_toOrdered
    (m : Nat) (lam : YoungDiagram (2 * (m + 1)))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * (m + 1))) :
    (∀ i j : S05_CanonicalEvenEigenbasisIndex (m + 1) lam,
...
theorem S05_arbitraryOddMatchingBasis_inner
  ...
  exact (S05_Lem5_20_canonicalOddMatchingEigenbasis m lam).1 i j
...
theorem S05_Lem5_20_arbitraryOddMatchingEigenbasis
    (m : Nat) (lam : YoungDiagram (2 * m + 1))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
...
theorem S05_arbitraryOddMatchingBasis_highLabelCount
  ...
  simp_rw [S05_matchingCharacterHigh_labelCast]
  exact S05_Lem5_19_highLabelCount_of_oddSignPatternMultiset
    (S05_canonicalOddEigenbasisLabel m lam)
...
theorem S05_Lem5_20_arbitraryOddMatchingEigenbasis_toOrdered
    (m : Nat) (lam : YoungDiagram (2 * m + 1))
    (action : YoungOrthogonalActionData lam)
    (M : NearPerfectMatching (2 * m + 1)) :
    (∀ i j : S05_CanonicalOddEigenbasisIndex m lam,
...
/-- Lemma 5.20 matching-operator component: a canonical even matching edge
operator is an involution. -/
theorem S05_Lem5_20_canonicalMatchingYoungOperatorEven_involutive
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 matching-operator component: distinct canonical even matching
edge operators commute. -/
theorem S05_Lem5_20_canonicalMatchingYoungOperatorEven_comm
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 matching-operator component: a canonical odd matching edge
operator is an involution. -/
theorem S05_Lem5_20_canonicalMatchingYoungOperatorOdd_involutive
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
...
/-- Lemma 5.20 matching-operator component: distinct canonical odd matching
edge operators commute. -/
theorem S05_Lem5_20_canonicalMatchingYoungOperatorOdd_comm
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.20 matching-edge eigenspace component: `v + A_r v` is a `+1`
eigenvector for an even matching edge. -/
theorem S05_Lem5_20_matchingEdge_plusEigenVec_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.20 matching-edge eigenspace component: `v - A_r v` is a `-1`
eigenvector for an even matching edge. -/
theorem S05_Lem5_20_matchingEdge_minusEigenVec_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
        (fun T => f T - canonicalMatchingYoungOperatorEven r f T) =
...
theorem S05_Lem5_20_matchingEdge_plusEigenVec_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.20 matching-edge eigenspace component: `v - A_r v` is a `-1`
eigenvector for an odd matching edge. -/
theorem S05_Lem5_20_matchingEdge_minusEigenVec_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
        (fun T => f T - canonicalMatchingYoungOperatorOdd r f T) =
...
/-- Lemma 5.20 matching-cube component: the zero cube element acts trivially in
the even canonical matching action. -/
theorem S05_Lem5_20_canonicalMatchingCubeOperatorEven_zero
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)} :
...
theorem S05_Lem5_20_canonicalMatchingCubeOperatorOdd_zero
    {m : Nat} {lam : YoungDiagram (2 * m + 1)} :
    canonicalMatchingCubeOperatorOdd (lam := lam) (cubeZero m) = id := by
  exact canonicalMatchingCubeOperatorOdd_zero

/-- Lemma 5.20 matching-cube component: the even canonical matching operators
respect the cube XOR law. -/
theorem S05_Lem5_20_canonicalMatchingCubeOperatorEven_xor
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (x y : Cube m) :
...
/-- Lemma 5.20 matching-cube component: the odd canonical matching operators
respect the cube XOR law. -/
theorem S05_Lem5_20_canonicalMatchingCubeOperatorOdd_xor
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (x y : Cube m) :
...
/-- Lemma 5.20 matching-cube component: the even canonical matching-cube
operator is the fixed ordered product of the selected edge operators. -/
theorem S05_Lem5_20_canonicalMatchingCubeOperatorEven_eq_indexedProduct
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (x : Cube m) :
...
/-- Lemma 5.20 matching-cube component: the odd canonical matching-cube
operator is the fixed ordered product of the selected edge operators. -/
theorem S05_Lem5_20_canonicalMatchingCubeOperatorOdd_eq_indexedProduct
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (x : Cube m) :
...
/-- Lemma 5.20 matching-character component: the product of selected edge
signs is the matching character. -/
theorem S05_Lem5_20_matchingEdgeSign_finRange_product_eq_matchingCharacter
...
/-- Lemma 5.20 matching-character component: on an even simultaneous
matching-edge eigenspace, the cube action is the product of selected edge
signs. -/
theorem S05_Lem5_20_matchingCube_product_action_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 matching-character component: on an odd simultaneous
matching-edge eigenspace, the cube action is the product of selected edge
signs. -/
theorem S05_Lem5_20_matchingCube_product_action_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {f : TableauSpace lam} {R : Finset (Fin m)}
...
theorem S05_Lem5_20_matchingCube_character_action_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    {f : TableauSpace lam} {R : Finset (Fin m)}
    (hf : S05_IsMatchingEigenvectorEven f R) (x : Cube m) :
    canonicalMatchingCubeOperatorEven (lam := lam) x f =
...
/-- Lemma 5.20 matching-character component: on an odd simultaneous
matching-edge eigenspace, the cube action is the matching character. -/
theorem S05_Lem5_20_matchingCube_character_action_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {f : TableauSpace lam} {R : Finset (Fin m)}
    (hf : S05_IsMatchingEigenvectorOdd f R) (x : Cube m) :
    canonicalMatchingCubeOperatorOdd (lam := lam) x f =
...
/-- Lemma 5.20 projection component: the one-edge even plus projection lands in
the `+1` eigenspace of that edge. -/
theorem S05_Lem5_20_matchingEdgePlusProjectionEven_isPlusEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.20 projection component: the one-edge even minus projection lands
in the `-1` eigenspace of that edge. -/
theorem S05_Lem5_20_matchingEdgeMinusProjectionEven_isMinusEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorEven r
...
/-- Lemma 5.20 projection component: the one-edge odd plus projection lands in
the `+1` eigenspace of that edge. -/
theorem S05_Lem5_20_matchingEdgePlusProjectionOdd_isPlusEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.20 projection component: the one-edge odd minus projection lands
in the `-1` eigenspace of that edge. -/
theorem S05_Lem5_20_matchingEdgeMinusProjectionOdd_isMinusEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.20 projection component: projecting to the `+1` eigenspace of one
even matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_20_matchingEdgePlusProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 projection component: projecting to the `-1` eigenspace of one
even matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_20_matchingEdgeMinusProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorEven s f = c • f) :
...
theorem S05_Lem5_20_matchingEdgePlusProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
...
/-- Lemma 5.20 projection component: projecting to the `-1` eigenspace of one
odd matching edge preserves every other edge eigenvalue. -/
theorem S05_Lem5_20_matchingEdgeMinusProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {r s : Fin m} (hrs : r ≠ s) {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorOdd s f = c • f) :
...
/-- Lemma 5.20 projection component: the sign-selected even one-edge
projection has the edge eigenvalue prescribed by the support. -/
theorem S05_Lem5_20_matchingEdgeSignProjectionEven_isMatchingEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 projection component: the sign-selected odd one-edge projection
has the edge eigenvalue prescribed by the support. -/
theorem S05_Lem5_20_matchingEdgeSignProjectionOdd_isMatchingEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (R : Finset (Fin m)) (r : Fin m) (f : TableauSpace lam) :
    canonicalMatchingYoungOperatorOdd r
...
/-- Lemma 5.20 projection component: the sign-selected even one-edge projection
preserves every other edge eigenvalue. -/
theorem S05_Lem5_20_matchingEdgeSignProjectionEven_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 projection component: the sign-selected odd one-edge projection
preserves every other edge eigenvalue. -/
theorem S05_Lem5_20_matchingEdgeSignProjectionOdd_preserves_otherEigen
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (R : Finset (Fin m)) {r s : Fin m} (hrs : r ≠ s)
    {c : ℝ} {f : TableauSpace lam}
    (hf : canonicalMatchingYoungOperatorOdd s f = c • f) :
...
/-- Lemma 5.20 projection component: the iterated even support-selected
projection is a simultaneous matching-edge eigenvector. -/
theorem S05_Lem5_20_matchingSignProjectionEven_isMatchingEigenvector
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 projection component: the iterated odd support-selected
projection is a simultaneous matching-edge eigenvector. -/
theorem S05_Lem5_20_matchingSignProjectionOdd_isMatchingEigenvector
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (R : Finset (Fin m)) (f : TableauSpace lam) :
    S05_IsMatchingEigenvectorOdd (matchingSignProjectionOdd R f) R := by
  exact matchingSignProjectionOdd_isMatchingEigenvector R f

/-- Lemma 5.20 one-edge component: an even matching edge fixes a same-row
tableau basis vector. -/
theorem S05_Lem5_20_matchingEdge_basis_sameRow_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
...
/-- Lemma 5.20 one-edge component: an even matching edge negates a same-column
tableau basis vector. -/
theorem S05_Lem5_20_matchingEdge_basis_sameCol_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.20 one-edge eigenspace component: in the even case, a same-row
tableau basis vector has eigenvalue `1`. -/
theorem S05_Lem5_20_matchingEdge_sameRow_eigen_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow : adjacentSameRow T (canonicalMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorEven r (tableauBasisVec T) =
...
/-- Lemma 5.20 one-edge eigenspace component: in the even case, a same-column
tableau basis vector has eigenvalue `-1`. -/
theorem S05_Lem5_20_matchingEdge_sameCol_eigen_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hcol : adjacentSameCol T (canonicalMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorEven r (tableauBasisVec T) =
...
/-- Lemma 5.20 one-edge component: in an even swappable edge, the diagonal
coordinate is the Young axial coefficient. -/
theorem S05_Lem5_20_matchingEdge_basis_swappable_self_value_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.20 one-edge component: in an even swappable edge, the swapped
coordinate is the Young off-diagonal coefficient. -/
theorem S05_Lem5_20_matchingEdge_basis_swappable_swap_value_even
    {m : Nat} {lam : YoungDiagram ((2 * m - 1) + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow_ne : ¬ adjacentSameRow T (canonicalMatchingAdjacentIndex m r))
    (hcol_ne : ¬ adjacentSameCol T (canonicalMatchingAdjacentIndex m r)) :
...
/-- Lemma 5.20 one-edge component: an odd matching edge fixes a same-row
tableau basis vector. -/
theorem S05_Lem5_20_matchingEdge_basis_sameRow_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.20 one-edge component: an odd matching edge negates a same-column
tableau basis vector. -/
theorem S05_Lem5_20_matchingEdge_basis_sameCol_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.20 one-edge eigenspace component: in the odd case, a same-row
tableau basis vector has eigenvalue `1`. -/
theorem S05_Lem5_20_matchingEdge_sameRow_eigen_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow : adjacentSameRow T (canonicalNearMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorOdd r (tableauBasisVec T) =
...
/-- Lemma 5.20 one-edge eigenspace component: in the odd case, a same-column
tableau basis vector has eigenvalue `-1`. -/
theorem S05_Lem5_20_matchingEdge_sameCol_eigen_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hcol : adjacentSameCol T (canonicalNearMatchingAdjacentIndex m r)) :
    canonicalMatchingYoungOperatorOdd r (tableauBasisVec T) =
...
/-- Lemma 5.20 one-edge component: in an odd swappable edge, the diagonal
coordinate is the Young axial coefficient. -/
theorem S05_Lem5_20_matchingEdge_basis_swappable_self_value_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
...
/-- Lemma 5.20 one-edge component: in an odd swappable edge, the swapped
coordinate is the Young off-diagonal coefficient. -/
theorem S05_Lem5_20_matchingEdge_basis_swappable_swap_value_odd
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    (T : StandardYoungTableau lam) (r : Fin m)
    (hrow_ne : ¬ adjacentSameRow T (canonicalNearMatchingAdjacentIndex m r))
    (hcol_ne : ¬ adjacentSameCol T (canonicalNearMatchingAdjacentIndex m r)) :
...
theorem S05_Lem5_20_highLabelCount_of_evenSignPatternMultiset
    {m : Nat} {lam : YoungDiagram (2 * m)}
    {ι : Type*} [Fintype ι]
    ...
    (∑ i : ι,
      ...
      hEvenTableau m lam := by
  exact S05_Lem5_19_highLabelCount_of_evenSignPatternMultiset label hlabels

/-- Once an odd matching eigenbasis is labeled by the genuine recursive
multiset, its high-label count is the active tableau height. -/
theorem S05_Lem5_20_highLabelCount_of_oddSignPatternMultiset
    {m : Nat} {lam : YoungDiagram (2 * m + 1)}
    {ι : Type*} [Fintype ι]
    (label : ι -> Finset (Fin m))
    ...
    (∑ i : ι,
        if S05_matchingCharacterHigh (label i) then (1 : Real) else 0) =
      hOddTableau m lam := by
  exact S05_Lem5_19_highLabelCount_of_oddSignPatternMultiset label hlabels
