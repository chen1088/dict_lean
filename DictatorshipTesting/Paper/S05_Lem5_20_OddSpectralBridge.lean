...
/-!
Paper statement: Lemma 5.20 (`lem:spectral-certificate-odd`)
...
theorem S05_Lem5_20_odd_spectral_bridge
    (m : Nat) (hm : 2 ≤ m) (c : ℝ)
...
theorem S05_Lem5_20_oddSpectralGapFromCertificates
    (m : Nat) (hm : 2 ≤ m) (c : ℝ)
    (hmodel : SpectralBlockModelInput
      (fun lam : YoungDiagram (2 * m + 1) => hOdd m lam))
    (hcert :
...
theorem S05_Lem5_20_tableauDim_oddSpectralGapFromCertificates
    (m : Nat) (hm : 2 <= m)
    (hmodel :
