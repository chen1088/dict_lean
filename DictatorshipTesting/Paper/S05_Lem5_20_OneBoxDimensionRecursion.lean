...
theorem S05_Lem5_20_tableauDim_fixed_oneBoxChild
...
theorem S05_Lem5_20_tableauDim_oneBox_branching
    {n : Nat} (lam : YoungDiagram (n + 1)) :
    tableauDim lam =
      (oneBoxChildrenSized lam).sum (fun mu => tableauDim mu) := by
  exact tableauDim_oneBox_branching_sized lam

theorem S05_Lem5_20_tableauDim_oneBoxChildrenOdd_branching
