...
- `DictatorshipTesting.Paper.S05_Lem5_49_OddCertificate`
-/


/-!
Paper statement: Lemma 5.22 (`lem:dimension-one-box-recurrence`)
...
theorem S05_Lem5_22_tableauDim_fixed_oneBoxChild
...
theorem S05_Lem5_22_tableauDim_oneBox_branching
    {n : Nat} (lam : YoungDiagram (n + 1)) :
    tableauDim lam =
      (oneBoxChildrenSized lam).sum (fun mu => tableauDim mu) := by
  exact tableauDim_oneBox_branching_sized lam

theorem S05_Lem5_22_tableauDim_oneBoxChildrenOdd_branching
