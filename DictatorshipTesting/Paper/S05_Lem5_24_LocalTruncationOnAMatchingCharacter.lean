...
matching characters. -/
theorem S05_Lem5_24_cubeLowDegreeOnePart_matchingCharacter_of_low {m : ℕ}
...
matching characters. -/
theorem S05_Lem5_24_cubeLowDegreeOnePart_matchingCharacter_of_high {m : ℕ}
...
theorem S05_Lem5_24_cubeLowDegreeOnePart_matchingCharacter_preserved_or_killed
    {m : ℕ} (S : Finset (Fin m)) :
    (cubeLowDegreeOnePart (fun x : Cube m => S05_matchingCharacter S x) =
  ...
  · exact Or.inl (S05_Lem5_24_cubeLowDegreeOnePart_matchingCharacter_of_low hlow)
  · exact Or.inr (S05_Lem5_24_cubeLowDegreeOnePart_matchingCharacter_of_high hhigh)

/-- Lemma 5.24, matching-character vocabulary: `P_M` preserves low local
matching characters. -/
theorem S05_Lem5_24_matchingLocalProjection_preserves_low_matchingCharacter
...
characters. -/
theorem S05_Lem5_24_matchingLocalProjection_kills_high_matchingCharacter
    {α : Type*} [Fintype α] [DecidableEq α] (M : OrderedMatching α)
    (F : Perm α → ℝ) (π : Perm α) {S : Finset (Fin M.edgeCount)}
