...
/-!
Paper statement: Lemma 5.25 (`lem:young-basis-scalar-commutant`)
...
abbrev S05_Lem5_25_YoungBasisScalarCommutantInput {n : Nat}
    (F : Perm (Fin n) → ℝ)
...
theorem S05_Lem5_25_matchingAverageScalarity_eq_sum {n : Nat}
    {F : Perm (Fin n) → ℝ}
    {blockEnergy theta : YoungDiagram n → ℝ}
    (h : S05_Lem5_25_YoungBasisScalarCommutantInput F blockEnergy theta) :
