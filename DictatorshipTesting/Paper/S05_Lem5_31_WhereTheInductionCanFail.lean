...
/-!
Paper statement: Lemma 5.31 (`lem:exceptional-even-children`)
...
/-- Lemma 5.33: all failures of the generic even induction are among the four
explicit exceptional shapes. -/
theorem S05_Lem5_31_where_the_induction_can_fail
