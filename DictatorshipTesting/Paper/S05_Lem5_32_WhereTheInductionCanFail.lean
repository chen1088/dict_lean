...
/-!
Paper statement: Lemma 5.32 (`lem:exceptional-even-children`)
...
/-- Lemma 5.32: all failures of the generic even induction are among the four
explicit exceptional shapes. -/
theorem S05_Lem5_32_where_the_induction_can_fail
