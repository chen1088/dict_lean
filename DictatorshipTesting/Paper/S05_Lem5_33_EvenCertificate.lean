...
import DictatorshipTesting.Paper.S05_Lem5_31_WeightZeroEntriesAreNeverAMajority

/-
Direct reverse imports:
- `DictatorshipTesting`
- `DictatorshipTesting.Paper.S05_Lem5_28_EvenSpectralBridge`
- `DictatorshipTesting.Paper.S05_Lem5_32_WhereTheInductionCanFail`
- `DictatorshipTesting.Paper.S05_Lem5_35_OddCertificate`
-/


/-!
Paper statement: Lemma 5.33 (`lem:h-even-app`)
...
/-!
# Finite induction proof for Lemma 5.33

The intended proof uses the weight-zero bound from Lemma 5.31, the `hEven` recurrence, the dimension
...
/-- Generic tableau-dimension induction step for Lemma 5.33, away from the
...
/-- Generic induction step for Lemma 5.33, away from the exceptional children.
...
/-- Finite Young-diagram induction behind Lemma 5.33, using actual tableau
counts. -/
...
/-- Lemma 5.33, tableau-count version of the even certificate. -/
theorem S05_Lem5_33_tableau_even_certificate
    (m : ℕ) (hm : 2 ≤ m)
    (lam : YoungDiagram (2 * m))
    (hrow : ¬ IsOneRow lam) (hstd : ¬ IsStandard lam) :
    (1 / 5 : ℝ) * tableauDim lam ≤ hEvenTableau m lam := by
...
/-- Finite Young-diagram induction behind Lemma 5.33. -/
...
/-- Lemma 5.33 paper-numbered alias: even certificate. -/
theorem S05_Lem5_33_even_certificate
    [TwoStripDimensionBranchingAssumption]
    (m : ℕ) (hm : 2 ≤ m)
    (lam : YoungDiagram (2 * m))
    (hrow : ¬ IsOneRow lam) (hstd : ¬ IsStandard lam) :
