...
/-!
Paper statement: Lemma 5.34 (`lem:exceptional-odd-children`)
...
/-- Lemma 5.34: all failures of the generic odd reduction are among the two
explicit odd exceptional shapes. -/
theorem S05_Lem5_34_odd_exceptional_children
