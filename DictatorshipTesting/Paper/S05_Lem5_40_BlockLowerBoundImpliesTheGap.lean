...
/-!
Paper statement: Lemma 5.40 (`lem:block-lower-bound-gap`)
...
spectral gap. -/
theorem S05_Lem5_40_block_lower_bound_implies_gap {n : Nat} (c : ℝ)
    (F : Perm (Fin n) -> ℝ)
...
theorem S05_Lem5_40_spectralGapFromBlockScalars {n : Nat} (c : ℝ)
    (F : Perm (Fin n) -> ℝ)
    (blockEnergy theta : YoungDiagram n -> ℝ)
    (hdecomp : YoungBlockDecompositionInput blockEnergy)
    (hu1 : U1YoungBlockIdentificationInput F blockEnergy)
...
theorem S05_Lem5_40_blockScalar_lower_bound_of_traceScalarFormula {n : Nat}
...
theorem S05_Lem5_40_traceScalarValue_of_blockTraceIdentity {n : Nat}
...
theorem S05_Lem5_40_spectralGapFromBlockTraceModel {n : Nat} (c : ℝ)
    (F : Perm (Fin n) -> ℝ)
...
theorem S05_Lem5_40_blockScalar_lower_bound_withDim {n : Nat}
...
theorem S05_Lem5_40_traceScalarValue_of_blockTraceIdentity_withDim {n : Nat}
...
function. -/
theorem S05_Lem5_40_spectralGapFromBlockScalarsWithDim {n : Nat} (c : ℝ)
    (F : Perm (Fin n) -> ℝ)
...
theorem S05_Lem5_40_spectralGapFromBlockTraceModelWithDim {n : Nat} (c : ℝ)
    (F : Perm (Fin n) -> ℝ)
...
theorem S05_Lem5_40_spectralGapFromBlockModelWithDim {n : Nat}
