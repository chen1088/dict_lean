...
import DictatorshipTesting.Paper.S05_Lem5_45_WeightZeroEntriesAreNeverAMajority

/-
Direct reverse imports:
- `DictatorshipTesting`
- `DictatorshipTesting.Paper.S05_Lem5_42_EvenSpectralBridge`
- `DictatorshipTesting.Paper.S05_Lem5_46_WhereTheInductionCanFail`
- `DictatorshipTesting.Paper.S05_Lem5_49_OddCertificate`
-/


/-!
Paper statement: Lemma 5.47 (`lem:h-even-app`)
...
theorem S05_Lem5_47_tableau_even_certificate
    (m : ℕ) (hm : 2 ≤ m)
    (lam : YoungDiagram (2 * m))
    (hrow : ¬ IsOneRow lam) (hstd : ¬ IsStandard lam) :
    (1 / 5 : ℝ) * tableauDim lam ≤ hEvenTableau m lam := by
...
theorem S05_Lem5_47_even_certificate
    [TwoStripDimensionBranchingAssumption]
    (m : ℕ) (hm : 2 ≤ m)
    (lam : YoungDiagram (2 * m))
    (hrow : ¬ IsOneRow lam) (hstd : ¬ IsStandard lam) :
