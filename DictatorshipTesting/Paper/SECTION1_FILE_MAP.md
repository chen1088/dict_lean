...
| --- | --- | --- | --- | --- | --- | --- |
| proven | 1.1 | theorem | Main theorem | `S01_Thm1_01_MainIntro.lean` | `Thm1_1_MainIntro` | Proved through the abstract tester-amplification wrapper `exists_dimensionFreeTester_of_oneTrialSoundness` and Lemma 4.13. Its active Lean dependencies include the Section 2 FKN/stability input and the Theorem 4.10 route documented in Section 4. Boolean `U_1` classification is not a direct dependency of this wrapper. |
