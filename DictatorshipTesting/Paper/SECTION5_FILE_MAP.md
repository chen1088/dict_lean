...
| unproven: requires SpectralBlockModelInputWithDim / spectral block model input | 5.27 | lemma | Even spectral bridge | `S05_Lem5_27_EvenSpectralBridge.lean` | `S05_Lem5_27_tableauDim_evenSpectralGapFromCertificates` | Finite even certificate is proved; missing input is the tableauDim/hEvenTableau spectral-block model. |
| unproven: requires SpectralBlockModelInputWithDim / spectral block model input | 5.28 | lemma | Odd spectral bridge | `S05_Lem5_28_OddSpectralBridge.lean` | `S05_Lem5_28_tableauDim_oddSpectralGapFromCertificates` | Finite odd certificate is proved; missing input is the tableauDim/hOddTableau spectral-block model. |
