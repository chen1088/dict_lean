...
| proven | 5.27 | lemma | Even spectral bridge | `S05_Lem5_27_EvenSpectralBridge.lean` | `S05_Lem5_27_tableauDim_evenSpectralGapFromCertificates` | Algebraic bridge proved from explicit spectral model hypothesis; Appendix A supplies this input for the paper application. |
| proven | 5.28 | lemma | Odd spectral bridge | `S05_Lem5_28_OddSpectralBridge.lean` | `S05_Lem5_28_tableauDim_oddSpectralGapFromCertificates` | Algebraic bridge proved from explicit spectral model hypothesis; Appendix A supplies this input for the paper application. |
