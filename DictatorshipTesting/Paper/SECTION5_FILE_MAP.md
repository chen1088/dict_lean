...
| 5.11 | lemma | One-box deletion intertwines earlier swaps | `S05_Lem5_11_OneBoxDeletionIntertwinesEarlierSwaps.lean` | `S05_Lem5_11_deleteMax_tableauContentSequence`, `S05_Lem5_11_deletionCoordinateMap_diagonalContent_intertwines` | partial: diagonal-content component proved |
...
| 5.14 | lemma | Two-box dimension recursion | `S05_Lem5_14_TwoBoxDimensionRecursion.lean` | `youngDim_twoStrip_branching_input`, `S05_Lem5_14_tableauDim_twoStrip_branching_sized` | legacy axiom dependency |
| 5.15 | lemma | One-box dimension recursion | `S05_Lem5_15_OneBoxDimensionRecursion.lean` | `youngDim_oneBox_branching_input`, `S05_Lem5_15_tableauDim_oneBoxChildrenOdd_branching` | legacy axiom dependency |
| 5.16 | lemma | Sizes of the sign-pattern multisets | `S05_Lem5_16_SizesOfTheSignPatternMultisets.lean` | `S05_Lem5_16_youngDim_twoStrip_size`, `S05_Lem5_16_youngDim_oneBox_size`, `S05_Lem5_16_tableauDim_twoStrip_size`, `S05_Lem5_16_tableauDim_oneBox_size` | tableauDim components proved; youngDim wrappers conditional |
| 5.17 | definition | Matching characters | `S05_Def5_17_MatchingCharacters.lean` | `S05_matchingCharacter`, `S05_matchingCharacter_cubeXor` | definition only |
| 5.18 | lemma | Matching subgroup eigenbasis | `S05_Lem5_18_MatchingSubgroupEigenbasis.lean` | `S05_Lem5_18_matchingCube_character_action_even`, `S05_Lem5_18_matchingEdgePlusProjectionEven_isPlusEigen` | conditional |
...
| 5.27 | lemma | Even spectral bridge | `S05_Lem5_27_EvenSpectralBridge.lean` | `S05_Lem5_27_evenSpectralGapFromCertificates`, `S05_Lem5_27_tableauDim_evenSpectralGapFromCertificates` | legacy axiom dependency |
| 5.28 | lemma | Odd spectral bridge | `S05_Lem5_28_OddSpectralBridge.lean` | `S05_Lem5_28_oddSpectralGapFromCertificates`, `S05_Lem5_28_tableauDim_oddSpectralGapFromCertificates` | legacy axiom dependency |
...
| 5.30 | lemma | Weight-zero entries are never a majority | `S05_Lem5_30_WeightZeroEntriesAreNeverAMajority.lean` | `S05_Lem5_30_weightZeroEntries_never_majority`, `S05_Lem5_30_tableau_weightZeroEntries_never_majority` | legacy axiom dependency |
...
| 5.32 | lemma | Even certificate | `S05_Lem5_32_EvenCertificate.lean` | `S05_Lem5_32_even_certificate`, `S05_Lem5_32_tableau_even_certificate` | legacy axiom dependency |
| 5.33 | lemma | Odd exceptional children | `S05_Lem5_33_OddExceptionalChildren.lean` | `S05_Lem5_33_odd_exceptional_children` | proved |
| 5.34 | lemma | Odd certificate | `S05_Lem5_34_OddCertificate.lean` | `S05_Lem5_34_odd_certificate`, `S05_Lem5_34_tableau_odd_certificate` | legacy axiom dependency |

Notes:

- `proved` means the Lean file proves the stated coordinate/combinatorial
  wrapper without new external assumptions.
- `conditional` means the file proves the wrapper from explicit interfaces, or
  records a coordinate-level version of a broader paper statement.
- `appendix input` means the Section 5 wrapper depends on one of the Appendix A
  external representation-theoretic inputs.
- `legacy axiom dependency` means an explicit named axiom remains for the
  legacy `youngDim` or spectral-block-model route; the tableau-count variants
  may already be internal.
