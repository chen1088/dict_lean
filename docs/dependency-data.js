window.DICT_DEPENDENCY_DATA = {
  ...
  nodes: [
    ...
    },
    {
      ...
      deps: ["S04_09", "S05_32", "S05_33", "S05_34"],
      summary: "Current route uses the tableauDim bridge and the Section 5 regular Young-block decomposition assembly lemma."
    },
    {
      id: "S05_06",
      label: "Lem 5.6",
    ...
    },
    {
      ...
      importance: "major",
      status: "proven",
      file: "DictatorshipTesting/Paper/S05_Lem5_35_CountingOneMoreMatchingEdge.lean",
      wrappers: ["S05_Lem5_35_counting_one_more_matching_edge"],
      deps: ["S05_17", "S05_18"],
    ...
    },
    {
      ...
      importance: "hero",
      status: "proven",
      file: "DictatorshipTesting/Paper/S05_Lem5_36_WeightZeroEntriesAreNeverAMajority.lean",
      wrappers: ["S05_Lem5_36_tableau_weightZeroEntries_never_majority"],
      deps: ["S05_35", "S05_19"],
    ...
    },
    {
      ...
      importance: "normal",
      status: "proven",
      file: "DictatorshipTesting/Paper/S05_Lem5_37_WhereTheInductionCanFail.lean",
      wrappers: ["S05_Lem5_37_where_the_induction_can_fail"],
      deps: ["S05_35"],
    ...
    },
    {
      ...
      importance: "normal",
      status: "proven",
      file: "DictatorshipTesting/Paper/S05_Lem5_39_OddExceptionalChildren.lean",
      wrappers: ["S05_Lem5_39_odd_exceptional_children"],
      deps: ["S05_20"],
    ...
    },
    {
      ...
      wrappers: ["S05_IsMatchingEigenvectorEven", "S05_IsMatchingEigenvectorOdd", "MatchingRestrictionEvenInput", "MatchingRestrictionOddInput", "S05_Lem5_23_matchingSignProjectionEven_isMatchingEigenvector"],
      deps: ["S05_06", "S05_12", "S05_16", "S05_17", "S05_18", "Lem5_23_IsMatchingEigenvectorEven", "Lem5_23_IsMatchingEigenvectorOdd", "Lem5_23_MatchingRestrictionEvenInput", "Lem5_23_MatchingRestrictionOddInput", "AuxYoungMatchingOperators"],
    ...
    {
      id: "Lem5_23_IsMatchingEigenvectorEven",
      label: "Lem 5.23 even eig",
      title: "Even matching eigenvector predicate",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_23_IsMatchingEigenvectorEven.lean",
      wrappers: ["S05_IsMatchingEigenvectorEven"],
      deps: ["AuxYoungMatchingOperators"],
      summary: "Lemma 5.23 component: simultaneous even matching-edge eigenvector predicate."
    },
    {
      id: "Lem5_23_IsMatchingEigenvectorOdd",
      label: "Lem 5.23 odd eig",
      title: "Odd matching eigenvector predicate",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_23_IsMatchingEigenvectorOdd.lean",
      wrappers: ["S05_IsMatchingEigenvectorOdd"],
      deps: ["AuxYoungMatchingOperators"],
      summary: "Lemma 5.23 component: simultaneous odd matching-edge eigenvector predicate."
    },
    {
      id: "Lem5_23_MatchingRestrictionEvenInput",
      label: "Lem 5.23 even input",
      title: "Even matching-restriction scalar input",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_23_MatchingRestrictionEvenInput.lean",
      wrappers: ["MatchingRestrictionEvenInput"],
      deps: ["S05_17"],
      summary: "Lemma 5.23 component: even scalar bounds for the matching-restriction data."
    },
    {
      id: "Lem5_23_MatchingRestrictionOddInput",
      label: "Lem 5.23 odd input",
      title: "Odd matching-restriction scalar input",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_23_MatchingRestrictionOddInput.lean",
      wrappers: ["MatchingRestrictionOddInput"],
      deps: ["S05_18"],
      summary: "Lemma 5.23 component: odd scalar bounds for the matching-restriction data."
    },
    {
    ...
    },
    {
      ...
      wrappers: ["TraceLocalTruncationEvenInput", "TraceLocalTruncationOddInput", "traceLocalTruncation_even_from_restriction", "traceLocalTruncation_odd_from_restriction"],
      deps: ["S05_23", "S05_24", "Lem5_25_TraceLocalTruncationEvenInput", "Lem5_25_TraceLocalTruncationOddInput"],
    ...
    {
      id: "Lem5_25_TraceLocalTruncationEvenInput",
      label: "Lem 5.25 even input",
      title: "Even local-truncation trace input",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_25_TraceLocalTruncationEvenInput.lean",
      wrappers: ["TraceLocalTruncationEvenInput"],
      deps: ["Lem5_23_MatchingRestrictionEvenInput"],
      summary: "Lemma 5.25 component: scalar trace formula for one even Young block."
    },
    {
      id: "Lem5_25_TraceLocalTruncationOddInput",
      label: "Lem 5.25 odd input",
      title: "Odd local-truncation trace input",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_25_TraceLocalTruncationOddInput.lean",
      wrappers: ["TraceLocalTruncationOddInput"],
      deps: ["Lem5_23_MatchingRestrictionOddInput"],
      summary: "Lemma 5.25 component: scalar trace formula for one odd Young block."
    },
    {
      id: "S05_26",
      label: "Def 5.26",
    ...
    },
    {
      ...
      deps: ["S05_06", "S05_07", "Lem5_29_YoungBasisScalarCommutantInput", "AppA_04"],
    ...
    {
      id: "Lem5_29_YoungBasisScalarCommutantInput",
      label: "Lem 5.29 input",
      title: "Young-basis scalar commutant input",
      section: "Matching algebra",
      kind: "aux",
      importance: "minor",
      status: "definition",
      file: "DictatorshipTesting/Paper/S05_Lem5_29_YoungBasisScalarCommutantInput.lean",
      wrappers: ["S05_Lem5_29_YoungBasisScalarCommutantInput"],
      deps: ["S05_08"],
      summary: "Lemma 5.29 component: scalarity of the averaged matching rejection on Young blocks."
    },
    {
      id: "S05_30",
      label: "Lem 5.30",
    ...
    },
    {
      ...
      importance: "hero",
      status: "proven",
      file: "DictatorshipTesting/Paper/S05_Lem5_32_RegularYoungBlockDecomposition.lean",
      ...
      deps: ["AppA_01", "AppA_02", "AppA_03", "AppA_04"],
      summary: "Internal assembly theorem: Appendix A ingredients imply the even and odd spectral-block model wrappers consumed by the spectral bridges."
    },
    {
      id: "S05_33",
      label: "Lem 5.33",
    ...
    },
    {
      ...
      deps: ["S05_32"],
      summary: "Even model wrapper supplied by the regular Young-block decomposition assembly lemma."
    },
    {
      ...
      deps: ["S05_32"],
      summary: "Odd model wrapper supplied by the regular Young-block decomposition assembly lemma."
    },
    {
      id: "AppA_01",
      label: "App A.1",
    ...
    },
    {
      ...
      wrappers: ["AppA_LemA_03_degreeOneYoungBlockIdentification", "AppA_LemA_03_l2DistSqToU1_eq_nonU1_sum"],
      deps: [],
    ...
    },
    {
      ...
      wrappers: ["AppA_LemA_04_standardTableauxSwapConnectedness"],
      deps: [],
